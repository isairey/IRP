...
try {
    ...
    // Consulta principal con d.ID_Diplomado agregado
    $query = "
...
?>
  ...
  <div class="d-flex justify-content-between ... border-bottom">
    <h1 class="h2">Diplomados Impartidos</h1>
  </div>
  ...
  <div class="d-flex justify-content-center py-4">
    <form class="d-flex" role="search">
      ...
      <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='./ver-asistentes.php'">
      ...
      <tbody>
        <?php foreach ($asignaciones as $a): ?>
          <tr>
            ...
            <td>
          <!-- Botón Asistentes que pasa el ID del diplomado -->
          <form method="GET" action="asistentes.php" style="display:inline;">
            <input type="hidden" name="id_diplomado" value="<?= $a['ID_Diplomado'] ?>">
            <button type="submit" class="boton-morado">Asistentes</button>
          </form>
        </td>
          </tr>
        <?php endforeach; ?>
