...
(
    SELECT 
        ...
        u.Email,
        a.FechaRegistro AS FechaAsignacion,
        'Usuario' AS Tipo
    FROM asistentes_taller a
    INNER JOIN usuario u ON a.ID_Persona = u.ID
    WHERE a.ID_Taller = :id AND a.TipoPersona = 'usuario'
)
UNION ALL
(
    SELECT 
    ...
    WHERE a.ID_Taller = :id AND a.TipoPersona = 'personal'
)
UNION ALL
(
    SELECT 
    ...
    WHERE a.ID_Taller = :id AND a.TipoPersona = 'participante'
)
ORDER BY Nombre ASC
";
...
$pdf->Cell(0, 10, 'Lista de Asistentes del Taller', 0, 1, 'C');
$pdf->Ln(5);
...
$pdf->Output('I', 'asistentes_taller.pdf');
?>
