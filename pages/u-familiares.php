...
?>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilio.php'">Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/u-familiares.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($usuarios as $usuario) {
        ...
        echo "<td>{$usuario['CallePC']}</td>";
        echo "<td>{$usuario['NumInteriorPC']}</td>";
        echo "<td>{$usuario['NumExteriorPC']}</td>";
        echo "<td>{$usuario['CPPC']}</td>";
        echo "<td>{$usuario['EstadoPC']}</td>";
        echo "<td>{$usuario['MunicipioPC']}</td>";
        echo "<td>{$usuario['ColoniaPC']}</td>";
        echo "<td>{$usuario['TelConfianza']}</td>";
        echo "<td>";
