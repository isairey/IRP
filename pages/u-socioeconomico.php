...
?>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilio.php'">Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/u-socioeconomico.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($usuarios as $usuario) {
        ...
        echo "<td>{$usuario['TipoEnergia']}</td>";
        echo "<td>{$usuario['TipoServicioAgua']}</td>";
        echo "<td>{$usuario['MaterialVivienda']}</td>";
        echo "<td>{$usuario['TipoBano']}</td>";
        echo "<td>{$usuario['TipoVivienda']}</td>";
        echo "<td>{$usuario['PersonasCasa']}</td>";
        echo "<td>{$usuario['PersonasDormitorio']}</td>";
        echo "<td>";
