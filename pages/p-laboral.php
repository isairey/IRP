...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Datos Laborales</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/ver-personal.php'">General</button>
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Datos de Domicilio</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-contacto.php'">Datos de Contacto</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-laboral.php'">Datos Laborales</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-salud.php'">Datos de Salud</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/p-laboral.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($personales as $personal) {
        ...
        echo "<td>{$personal['GradoAcademico']}</td>";
        echo "<td>{$personal['ClasificacionPersonal']}</td>";
        echo "<td>{$personal['AreaAsignada']}</td>";
        echo "<td>{$personal['EstatusPersonal']}</td>";
        echo "<td>{$personal['Institucion']}</td>";
        echo "<td>{$personal['FechaIngreso']}</td>";
        echo "<td>{$personal['FechaTermino']}</td>";
        echo "<td>";
        // Botón para editar
        echo "<a href='../checkout/editar-personal.php?id={$personal['ID_Personal']}' class='btn btn-primary btn-sm'>Editar</a>";
        // Botón para eliminar
        echo "<button class='btn btn-danger btn-sm eliminar-personal' data-id='{$personal['ID_Personal']}'>Eliminar</button>";
        echo "</td>";
        echo "</tr>";
    }
