...
?>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilio.php'">Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/u-domicilio.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($usuarios as $usuario) {
        ...
        echo "<td>{$usuario['Calle']}</td>";
        echo "<td>{$usuario['NumInterior']}</td>";
        echo "<td>{$usuario['NumExterior']}</td>";
        echo "<td>{$usuario['CP']}</td>";
        echo "<td>{$usuario['Estado']}</td>";
        echo "<td>{$usuario['Municipio']}</td>";
        echo "<td>{$usuario['Colonia']}</td>";
        echo "<td>{$usuario['Region']}</td>";
        echo "<td>";
