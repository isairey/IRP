...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">DATOS DE DECENDENCIA</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilioa.php'">Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/u-decendencia.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
    ...
    <table class="table table-striped table-sm" id="miTabla">
        <thead>
            <tr>
                ...
                <th>Nombre Hijo</th>
                <th>Fecha de Nacimiento Hijo</th>
                <th>Sexo Hijo</th>
                <th>Escolaridad Hijo</th>
                <th>Condición Hijo</th>
            </tr>
        </thead>
        <tbody>
       <?php
...
<?php if (isset($_GET['status'])): ?>
    ...
    <script>
        Swal.fire({
            ...
            title: "<?= $_GET['status'] === 'success' ? 'Hijos registrados correctamente' : 'Error al registrar' ?>",
