...
?>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Datos de Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/p-salud.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
    ...
    <table class="table table-striped table-sm">
        <thead>
            <tr>
                ...
                <th>Problemas de Salud Considerables</th>
                <th>Problemas de Movilidad</th>
                <th>Observaciones</th>
                <th>Acciones</th>
            </tr>
        </thead>
...
try {
    ...
    foreach ($personales as $personal) {
        ...
        echo "<td>{$personal['ProblemasSaludConsiderables']}</td>";
        echo "<td>{$personal['ProblemasMovilidad']}</td>";
        echo "<td>{$personal['Observaciones']}</td>";
        echo "<td>";
        // Botón para editar
