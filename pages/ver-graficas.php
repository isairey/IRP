...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Gráfico de Usuarios por Tipo de Violencia</title>
      ...
      <div class="container">
        ...
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-header">
                        Usuarios por Tipo de Violencia
                    </div>
                    <div class="card-body">
...
<script src="../assets/dist/js/bootstrap.bundle.min.js"></script>
 ...
 <script>
        ...
        // Segundo gráfico: Tipo de Atención
        <?php
        try {
        ...
        // Tercer gráfico: Usuarios por Municipio
        <?php
        try {
        ...
        // Cuarto gráfico: Usuarios por Región
        <?php
        try {
        ...
        const myChart1 = new Chart(ctx1, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: generateRandomColors(Object.keys(<?php echo $datos_json1; ?>).length),
                    hoverOffset: 4
                }]
            },
            options: {
        ...
        const myChart2 = new Chart(ctx2, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: generateRandomColors(Object.keys(<?php echo $datos_json2; ?>).length),
                    hoverOffset: 4
                }]
            },
            options: {
        ...
        const myChart4 = new Chart(ctx4, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    backgroundColor: generateRandomColors(Object.keys(<?php echo $datos_json4; ?>).length),
                    hoverOffset: 4
                }]
            },
            options: {
