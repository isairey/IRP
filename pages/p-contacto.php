...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Datos de Contacto Personal</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Datos de Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/p-contacto.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($personales as $personal) {
        ...
        echo "<td>{$personal['Tel']}</td>";
        echo "<td>{$personal['Email']}</td>";
        echo "<td>{$personal['NombreContactoEmergencia']}</td>";
        echo "<td>{$personal['TelContactoEmergencia']}</td>";
        echo "<td>";
        // Botón para editar
