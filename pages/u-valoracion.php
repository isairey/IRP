...
?>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilio.php'">Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/u-valoracion.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($usuarios as $usuario) {
        ...
        echo "<td>{$usuario['SituacionUsuaria']}</td>";
        echo "<td>{$usuario['ValoracionRiesgo']}</td>";
        echo "<td>{$usuario['Canalizacion']}</td>";
        echo "<td>{$usuario['CanalizacionExterna']}</td>";
