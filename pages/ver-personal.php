...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Lista del Personal</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Domicilio</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-contacto.php'">Contacto</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-laboral.php'">Laborales</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-salud.php'">Salud</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/ver-personal.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll('.eliminar-personal').forEach(button => {
        ...
        window.location.href = `./eliminar_personal.php?eliminar_id=${donacionId}`;
                    Swal.fire({
                        icon: 'success',
                        title: '¡Eliminado!',
