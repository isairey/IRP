...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Listado de Donaciones</h1>
    ...
    <button class="btn btn-primary rounded-pill px-3" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Datos de Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/ver-donaciones.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($donativos as $donativo) {
        echo "<tr>";
        echo "<td>{$donativo['ID_Donativo']}</td>";
        echo "<td>{$donativo['NombreCompleto']}</td>";
