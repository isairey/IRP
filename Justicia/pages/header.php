...
if (strpos($foto, "uploads/") !== false) {
    // Si ya trae "uploads/personal/imagen.jpg"
    $fotoFinal = "../../" . htmlspecialchars($foto);
} else {
    // Si solo trae "imagen.jpg"
...
<header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark" style="height:60px;">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="./../pages/home.php">Ges Mujer</a>
