...
$stmt = $conn->prepare("SELECT Nombre FROM talleres WHERE ID_Taller = :idTaller");
$stmt->bindValue(':idTaller', $idTaller, PDO::PARAM_INT);
$stmt->execute();

$tallers = $stmt->fetch(PDO::FETCH_ASSOC);
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Asistentes del Taller <?= htmlspecialchars($tallers['Nombre']) ?></h1>
