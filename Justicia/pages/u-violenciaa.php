...
?>
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          ...
          <label for="tipo_violencia"></label>
            <select class="form-select" id="tipo_violencia" onchange="filtrarPorTipoViolencia()">
                <option selected disabled value="">Tipo de Violencia</option>
                <option value="PATRIMONIAL">PATRIMONIAL</option>
                <option value="FÍSICA">FÍSICA</option>
                <option value="PSICOLÓGICA">PSICOLÓGICA</option> 
                <option value="ECONÓMICA">ECONÓMICA</option>
                <option value="SEXUAL">SEXUAL</option>
                <option value="FEMINICIDA">FEMINICIDA</option>
                <option value="POLÍTICA">POLÍTICA</option>
                <option value="SIMBÓLICA">SIMBÓLICA</option>
                <option value="CIBERNÉTICA">CIBERNÉTICA</option>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilioa.php'">Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/u-violenciaa.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    $query = "SELECT u.id AS usuario_id, u.Nombre AS usuario_nombre, u.ApellidoPaterno AS usuario_apellido_paterno, u.ApellidoMaterno AS usuario_apellido_materno, tv.Nombre_tipo AS tipo_violencia_nombre
              FROM tutor u
              INNER JOIN tutor_Tipos_Violencia utv ON u.id = utv.ID_tutor
...
<script>
function filtrarPorTipoViolencia() {
    var select = document.getElementById("tipo_violencia");
    ...
    for (var i = 1; i < filas.length; i++) {
        var tipoViolencia = filas[i].getElementsByTagName("td")[2].innerHTML;
        
        if (tipoSeleccionado === "todos" || tipoViolencia.includes(tipoSeleccionado)) {
