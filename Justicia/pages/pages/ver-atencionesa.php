...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Atenciones Realizadas</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/ver-atencionestotalesa.php'">Reporte de Datos</button>
      ...
      <button class="btn btn-danger rounded-pill px-3" type="button" onclick="window.location.href='../pages/p-laboral.php'">Datos Laborales</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/ver-atencionesa.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    if (isset($_GET['search']) && !empty($_GET['search'])) {
        $condiciones[] = "CONCAT(U.nombre2, ' ', U.apellidoPaterno2, ' ', U.apellidoMaterno2, ' ', 
    ...
    foreach ($detalles_atencion as $detalle) { 
        ...
        echo "<td>";
        echo "<a href='../checkout/editar-atencionesa.php?id={$detalle['ID_Detalle']}' class='btn btn-primary btn-sm'><i class='bi bi-pencil-square'></i></a> ";
...
document.addEventListener("DOMContentLoaded", () => {
    document.querySelectorAll('.eliminar-detalle').forEach(button => {
        ...
        window.location.href = `./eliminar_atenciona.php?eliminar_id=${donacionId}`;
                    Swal.fire({
                        icon: 'success',
                        title: '¡Eliminado!',
