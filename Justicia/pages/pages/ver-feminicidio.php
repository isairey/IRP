...
<?php if (isset($_GET['statuss'])): ?>
    ...
    <script>
        Swal.fire({
            ...
            title: "<?= $_GET['statuss'] === 'updated' ? 'Feminicidio Actualizado correctamente' : 'Error al registrar' ?>",
...
<?php if (isset($_GET['status'])): ?>
    ...
    <script>
        Swal.fire({
            ...
            title: "<?= $_GET['status'] === 'success' ? 'Feminicidio registrado correctamente' : 'Error al registrar' ?>",
...
<script>
        ...
        document.querySelectorAll('.eliminar-feminicidio').forEach(button => {
            button.addEventListener('click', () => {
                ...
                if (confirm('¿Estás seguro de que deseas eliminar este personal?')) {
                    ...
                    window.location.href = `eliminar_feminicidio.php?eliminar_id=${userId}`;
                }
            });
        });
    </script>
