...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Lista de Proyectos</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/ver-proyectos-asignados.php'">Proyectos Asignados</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/reporte-proyecto.php'">Reportes</button>
...
<?php if (isset($_GET['status'])): ?>
    ...
    <script>
        Swal.fire({
            ...
            title: "<?= $_GET['status'] === 'success' ? 'Peroyecto registrado correctamente' : 'Error al registrar' ?>",
...
<?php if (isset($_GET['statuss'])): ?>
    ...
    <script>
        Swal.fire({
            ...
            title: "<?= $_GET['statuss'] === 'success' ? 'Peroyecto Asignado correctamente' : 'Error al registrar' ?>",
