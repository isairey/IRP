...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          ...
          <button type="button" class="btn btn-sm btn-outline-secondary dropdown-toggle d-flex align-items-center gap-1" onclick="window.location.href='../pages/reporte-usuarias.php'">
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/ver-usuaria.php'">General</button>
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-domicilio.php'">Domicilio</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-familiares.php'">Confianza</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-contacto.php'">Contacto</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-comprobables.php'">Documentos</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-valoracion.php'">Valoracion</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-decendencia.php'">Decendencia</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-socioeconomico.php'">Socioeconómico</button>
      <button class="boton-morado" type="button" onclick="window.location.href='../pages/u-violencia.php'">Violencia</button>
      <button class="btn btn-link rounded-pill px-3" type="button" onclick="window.location.href='../pages/u-domicilio.php'"></button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/ver-usuaria.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
