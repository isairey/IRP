...
// Obtener usuarios
$stmtUsuarios = $conn->query("SELECT ID, CONCAT(nombre2, ' ', apellidoPaterno2, ' ', apellidoMaterno2) AS Nombre FROM tutor ORDER BY Nombre");
$usuarios4 = $stmtUsuarios->fetchAll(PDO::FETCH_ASSOC);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $sql = "UPDATE detalles_atenciona SET 
        ID_tutor = :usuario,
    ...
    $stmt->execute([
      ...
      header("Location: ../pages/ver-atencionesa.php?status=updated");
        exit;
}
            ...
            <div class="row g-3">
                ...
                <div class="col-sm-6">
                    ...
                    <select name="ID_Usuario" class="form-select" required>
                        ...
                        <?php foreach ($usuarios4 as $u): ?>
                            <option value="<?= $u['ID'] ?>" <?= $u['ID'] == $atencion['ID_tutor'] ? 'selected' : '' ?>>
