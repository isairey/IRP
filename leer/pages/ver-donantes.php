...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Listado de Donates</title>
...
?>
    ...
    <button class="btn btn-primary rounded-pill px-3" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Datos de Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/ver-donantes.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    document.querySelectorAll('.eliminar-donante').forEach(button => {
        button.addEventListener('click', () => {
            // Preguntar al usuario si está seguro de eliminar
            if (confirm('¿Estás seguro de que deseas eliminar este donante?')) {
                // Obtener el ID del donante de los datos del botón
                const donanteId = button.getAttribute('data-id');
                // Redirigir a la página de PHP para eliminar el donante
                window.location.href = `eliminar-donante.php?id=${donanteId}`;
            }
        });
    });
});
