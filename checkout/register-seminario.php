...
<html lang="en" data-bs-theme="auto">
    ...
    <main>
        ...
        <div class="row g-5">
            <div class="col-12">
              <form action="register-seminario.php" method="POST" class="needs-validation" novalidate>
    <div class="mb-3">
        <label for="nombre" class="form-label">Nombre del Seminario</label>
    ...
    <button class="btn btn-primary w-100" type="submit">Registrar Seminario</button>
</form>
