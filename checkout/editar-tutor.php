...
try {
    $id = $_GET['id'];
     ...
     $mensaje = "";
$tipoMensaje = "";
    $stmt = $conn->prepare("SELECT * FROM tutor WHERE id = :id");
...
$id_personal2 = $_POST['personal_input2'];
$nombre2 = $_POST['nombre2'];
$apellidoPaterno2 = $_POST['apellidoPaterno2'];
$apellidoMaterno2 = $_POST['apellidoMaterno2'];
$fechaNacimiento2 = $_POST['fechaNacimiento2'];
$edad2 = $_POST['edad2'];
$fecharegistro2 = $_POST['fecharegistro2'];
$lugarNacimiento2 = $_POST['lugarNacimiento2'];

$sexo2 = $_POST['sexo2'];
$indigena2 = $_POST['indigena2'];
$lenguaMaterna2 = $_POST['lenguaMaterna2'];
$hablaLenguaIndigena2 = $_POST['hablaLenguaIndigena2'];
$lenguaIndigena2 = $_POST['lenguaIndigena2'];
$telFijo2 = $_POST['telFijo2'];
$telCelular2 = $_POST['telCelular2'];
$email2 = $_POST['email2'];
$emailRespaldo2 = $_POST['emailRespaldo2'];
$telConfianza2 = $_POST['telConfianza2'];
$nombreconfianza2 = $_POST['nombreconfianza2'];
$parentesco2 = $_POST['parentesco2'];
$comunidadLGBT2 = $_POST['comunidadLGBT2'];
$tipoLgbt2 = $_POST['tipoLgbt2'];
$estadocivil2 = $_POST['estadocivil2'];
$calle2 = $_POST['calle2'];
$numInterior2 = $_POST['numInterior2'];
$numExterior2 = $_POST['numExterior2'];
$estado2 = $_POST['estado2'];
$cp2 = $_POST['cp2'];
$region2 = $_POST['region2'];
$municipio2 = $_POST['municipio2'];
$colonia2 = $_POST['colonia2'];
$perteneceEtnico2 = $_POST['perteneceEtnico2'];
$grupoEtnico2 = $_POST['grupoEtnico2'];
$padresLengua2 = $_POST['padresLengua2'];
$lenguaPadres2 = $_POST['lenguaPadres2'];
$aniosOaxaca2 = $_POST['aniosOaxaca2'];
$asiste_escuela2 = $_POST['asiste_escuela2'];
$escolaridad2 = $_POST['escolaridad2'];
$escuela_actual2 = $_POST['escuela_actual2'];
$grado_escolar2 = $_POST['grado_escolar2'];
$sentimiento_escuela2 = $_POST['sentimiento_escuela2'];
$materias_gustan2 = $_POST['materias_gustan2'];
$dificultades2 = $_POST['dificultades2'];
$descripcion_dificultad2 = $_POST['descripcion_dificultad2'];
$relaciones_escolares2 = $_POST['relaciones_escolares2'];
$convivencia2 = $_POST['convivencia2'];
$num_personas_casa2 = $_POST['num_personas_casa2'];
$personas_significativas2 = $_POST['personas_significativas2'];
$sentir_casa2 = $_POST['sentir_casa2'];
$expresion_familiar2 = $_POST['expresion_familiar2'];
$motivoExpresion2 = $_POST['motivoExpresion2'];
$amistades_cercanas2 = $_POST['amistades_cercanas2'];
$descripcion_amistades2 = $_POST['descripcion_amistades2'];
$actividades_libre2 = $_POST['actividades_libre2'];
$uso_redes2 = $_POST['uso_redes2'];
$redes_cuales2 = $_POST['redes_cuales2'];
$redes_tiempo2 = $_POST['redes_tiempo2'];
$seguridad_comunidad2 = $_POST['seguridad_comunidad2'];
$motivo_inseguridad2 = $_POST['motivo_inseguridad2'];
$discapacidads2 = $_POST['discapacidads2'];
$discapacidad2 = $_POST['discapacidad2'];
$apoyo_psicologico2 = $_POST['apoyo_psicologico2'];
$detalle_apoyo2 = $_POST['detalle_apoyo2'];
$estado_animo2 = $_POST['estado_animo2'];
$motivo_visita2 = $_POST['motivo_visita2'];
$descripcion_evento2 = $_POST['descripcion_evento2'];
$controlan_actividad2 = $_POST['controlan_actividad2'];
$violencia_verbal2 = $_POST['violencia_verbal2'];
$violencia_fisica2 = $_POST['violencia_fisica2'];
$violencia_sexual2 = $_POST['violencia_sexual2'];
$impiden_estudiar2 = $_POST['impiden_estudiar2'];
$difusion_sin_permiso2 = $_POST['difusion_sin_permiso2'];
$observacionesvi2 = $_POST['observacionesvi2'];
$ocupacion2 = $_POST['ocupacion2'];
$tipoEmpleo2 = $_POST['tipoEmpleo2'];
$DondeTrabaja2 = $_POST['DondeTrabaja2'];
$fuenteIngresos2 = $_POST['fuenteIngresos2'];
$sectorEconomico2 = $_POST['sectorEconomico2'];
$horasTrabajo2 = $_POST['horasTrabajo2'];
$ingresosDiarios2 = $_POST['ingresosDiarios2'];
$ingresoMensual2 = $_POST['ingresoMensual2'];
$apoyosSociales2 = $_POST['apoyosSociales2'];
$recibeApoyo2 = $_POST['recibeApoyo2'];
$apoyoDetalle2 = $_POST['apoyoDetalle2'];
$enteroGESMUJER2 = $_POST['enteroGESMUJER2'];
$descripcionSolicitud2 = $_POST['descripcionSolicitud2'];
...
/*   campos que faltan para actualizar 
...
*/
    ...
    sexo2 = :sexo2,
    indigena2 = :indigena2,
    lenguaMaterna2 = :lenguaMaterna2,
    hablaLenguaIndigena2 = :hablaLenguaIndigena2,
    lenguaIndigena2 = :lenguaIndigena2,
    telFijo2 = :telFijo2,
    telCelular2 = :telCelular2,
    email2 = :email2,
    emailRespaldo2 = :emailRespaldo2,
    telConfianza2 = :telConfianza2,
    nombreconfianza2 = :nombreconfianza2,
    parentesco2 = :parentesco2,
    comunidadLGBT2 = :comunidadLGBT2,
    tipoLgbt2 = :tipoLgbt2,
    estadocivil2 = :estadocivil2,
    calle2 = :calle2,
    numInterior2 = :numInterior2,
    numExterior2 = :numExterior2,
    estado2 = :estado2,
    cp2 = :cp2,
    region2 = :region2,
    municipio2 = :municipio2,
    colonia2 = :colonia2,
    perteneceEtnico2 = :perteneceEtnico2,
    grupoEtnico2 = :grupoEtnico2,
    padresLengua2 = :padresLengua2,
    lenguaPadres2 = :lenguaPadres2,
    aniosOaxaca2 = :aniosOaxaca2,
    asiste_escuela2 = :asiste_escuela2,
    escolaridad2 = :escolaridad2,
    escuela_actual2 = :escuela_actual2,
    grado_escolar2 = :grado_escolar2,
    sentimiento_escuela2 = :sentimiento_escuela2,
    materias_gustan2 = :materias_gustan2,
    dificultades2 = :dificultades2,
    descripcion_dificultad2 = :descripcion_dificultad2,
    relaciones_escolares2 = :relaciones_escolares2,
    decendencia2 = :decendencia2, 
    numDecendencia2 = :numDecendencia2, 
    observacionesAdicionales2 = :observacionesAdicionales2,
    convivencia2 = :convivencia2,
    num_personas_casa2 = :num_personas_casa2,
    personas_significativas2 = :personas_significativas2,
    sentir_casa2 = :sentir_casa2,
    expresion_familiar2 = :expresion_familiar2,
    motivoExpresion2 = :motivoExpresion2,
    amistades_cercanas2 = :amistades_cercanas2,
    descripcion_amistades2 = :descripcion_amistades2,
    actividades_libre2 = :actividades_libre2,
    uso_redes2 = :uso_redes2,
    redes_cuales2 = :redes_cuales2,
    redes_tiempo2 = :redes_tiempo2,
    seguridad_comunidad2 = :seguridad_comunidad2,
    motivo_inseguridad2 = :motivo_inseguridad2,
    discapacidads2 = :discapacidads2,
    discapacidad2 = :discapacidad2,
    apoyo_psicologico2 = :apoyo_psicologico2,
    detalle_apoyo2 = :detalle_apoyo2,
    estado_animo2 = :estado_animo2,
    motivo_visita2 = :motivo_visita2,
    descripcion_evento2 = :descripcion_evento2,
    controlan_actividad2 = :controlan_actividad2,
    violencia_verbal2 = :violencia_verbal2,
    violencia_fisica2 = :violencia_fisica2,
    violencia_sexual2 = :violencia_sexual2,
    impiden_estudiar2 = :impiden_estudiar2,
    difusion_sin_permiso2 = :difusion_sin_permiso2,
    observacionesvi2 = :observacionesvi2,
    ocupacion2 = :ocupacion2,
    tipoEmpleo2 = :tipoEmpleo2,
    DondeTrabaja2 = :DondeTrabaja2,
    fuenteIngresos2 = :fuenteIngresos2,
    sectorEconomico2 = :sectorEconomico2,
    horasTrabajo2 = :horasTrabajo2,
    ingresosDiarios2 = :ingresosDiarios2,
    ingresoMensual2 = :ingresoMensual2,
    apoyosSociales2 = :apoyosSociales2,
    recibeApoyo2 = :recibeApoyo2,
    apoyoDetalle2 = :apoyoDetalle2,
    enteroGESMUJER2 = :enteroGESMUJER2,
    descripcionSolicitud2 = :descripcionSolicitud2
...
//print_r(array_unique($matches[0]));
        ...
        //  :decendencia2, :numDecendencia2, :observacionesAdicionales2 están en $params, pero no en la consulta SQL.
...
<div class="col-sm-6">
    ...
    <input 
        ...
        <?php 
            if (!empty($usuario['FechaNacimiento']) && $usuario['FechaNacimiento'] != '0000-00-00') {
                echo 'value="' . $usuario['FechaNacimiento'] . '"';
            }
        ?>
    >
    ...
    <input 
        ...
        name="edad"
        <?php 
            if (!empty($usuario['Edad']) && $usuario['Edad'] != 0  && $usuario['Edad'] != "-") {
                echo 'value="' . $usuario['Edad'] . '"';
            } else {
                echo 'placeholder="SIN DATOS"';
            }
        ?>
    >
 ...
 <div class="col-sm-6">
    ...
    <input type="text" 
           ...
           value="<?php echo (!empty($usuario['LugarNacimiento']) && $usuario['LugarNacimiento'] != '-') ? $usuario['LugarNacimiento'] : ''; ?>"  
           placeholder="<?php echo (empty($usuario['LugarNacimiento']) || $usuario['LugarNacimiento'] == '-') ? 'SIN DATOS' : ''; ?>"
           autocomplete="off">
...
input.addEventListener('blur', () => {
    ...
    <div class="form-check">
    <input class="form-check-input" type="radio" name="indigena" id="indigenaopcion3" value="SIN DATOS" 
        <?php if($usuario['Indigena'] == 'SIN DATOS' || $usuario['Indigena'] == '-') echo 'checked'; ?>>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hablaLenguaIndigena" id="radioSi" 
      value="SI" onclick="toggleLanguageSelect(true)" 
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hablaLenguaIndigena" id="radioNo" 
      value="NO" onclick="toggleLanguageSelect(false)" 
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="hablaLenguaIndigena" id="radioSinDatos" 
      value="SIN DATOS" onclick="toggleLanguageSelect(false)" 
      <?php if ($usuario['HablaLenguaIndigena'] == 'SIN DATOS' || $usuario['HablaLenguaIndigena'] == '-' || empty($usuario['HablaLenguaIndigena'])) echo 'checked'; ?>>
    <label class="form-check-label" for="radioSinDatos">SIN DATOS</label>
  </div>
</div>

<div class="col-sm-6" id="languageSelectContainer3" style="display:none;">
  <label for="lenguaIndigena3" class="form-label">¿Cuál?</label>
  <select class="form-select" id="lenguaIndigena3" name="lenguaIndigena">
    <?php
      $lenguas = ['SIN DATOS', 'Zapoteco', 'Mixteco', 'Mazateco', 'Chinanteco', 'Mixe', 'Triqui', 
                  'Chatino', 'Amuzgo', 'Cuicateco', 'Trique', 'Huave', 'Chontal', 
                  'Ixcateco', 'Zoque', 'Náhuatl', 'Otros'];

      $lenguaUsuario = isset($usuario['LenguaIndigena']) && trim($usuario['LenguaIndigena']) != '' && $usuario['LenguaIndigena'] != '-' 
      ...
      foreach ($lenguas as $lengua) {
        if (strcasecmp($lenguaUsuario, $lengua) != 0) {
...
function toggleLanguageSelect(show) {
  document.getElementById('languageSelectContainer3').style.display = show ? 'block' : 'none';
  if (!show) {
    document.getElementById('lenguaIndigena3').value = 'SIN DATOS';
  }
}

// Mostrar automáticamente el select si la BD dice "SI"
document.addEventListener('DOMContentLoaded', function() {
  const selected = document.querySelector('input[name="hablaLenguaIndigena"]:checked');
  if (selected && selected.value.toUpperCase() === 'SI') {
    toggleLanguageSelect(true);
  }
});
</script>
...
<h4>Datos de Contacto</h4>
    ...
    <input 
        ...
        id="telCelular" 
        name="telCelular" 
        placeholder="<?php echo (!empty($usuario['TelCelular']) && $usuario['TelCelular'] != '-') ? $usuario['TelCelular'] : 'SIN DATOS'; ?>"
        value="" 
    ><br>
...
<div class="col-sm-6">
    ...
    <input 
        ...
        id="telFijo" 
        name="telFijo" 
        placeholder="<?php echo (!empty($usuario['TelFijo']) && $usuario['TelFijo'] != '-') ? $usuario['TelFijo'] : 'SIN DATOS'; ?>"
        value="" 
    ><br>
   ...
   <div class="col-sm-6">
    ...
    <div class="input-group has-validation">
        ...
        <input 
            ...
            id="email" 
            name="email" 
            placeholder="<?php echo (!empty($usuario['Email']) && $usuario['Email'] != '-') ? $usuario['Email'] : 'SIN DATOS'; ?>" 
            value=""
        ><br>
...
<div class="col-sm-6">
    ...
    <div class="input-group has-validation">
        ...
        <input 
            ...
            id="emailRespaldo" 
            name="emailRespaldo" 
            placeholder="<?php echo (!empty($usuario['EmailRespaldo']) && $usuario['EmailRespaldo'] != '-') ? $usuario['EmailRespaldo'] : 'SIN DATOS'; ?>" 
            value=""
        ><br>
    </div>
</div>
...
<div class="col-sm-6">
    ...
    <input 
        ...
        id="telConfianza" 
        name="telConfianza" 
        value="<?php echo (!empty($usuario['TelConfianza']) && $usuario['TelConfianza'] != '-') ? $usuario['TelConfianza'] : 'SIN DATOS'; ?>"
    ><br>
...
<div class="col-sm-6">
    ...
    <input 
        ...
        class="form-control" 
        id="firstname" 
        name="nombreconfianza" 
        placeholder="<?php echo (!empty($usuario['nombreconfianza']) && $usuario['nombreconfianza'] != '-') ? $usuario['nombreconfianza'] : 'SIN DATOS'; ?>" 
        value=""
    >
    <div class="invalid-feedback">Se requiere un nombre válido.</div>
</div>
...
<div class="col-sm-6">
  ...
  <select class="form-select" id="parentesco" name="parentesco">
    <?php 
      // Valor de BD, si está vacío o es '-', usar 'SIN DATOS'
      $parentesco = (!empty($usuario['perentesco']) && $usuario['perentesco'] != '-') ? $usuario['perentesco'] : 'SIN DATOS';
    ?>
...
<h4>Datos Generales</h4>
  ...
  <input 
    type="text" 
    id="personal_input" 
    name="personal_input2" 
    class="form-control" 
    placeholder="Escribe el nombre del especialista..." 
    value="<?php echo isset($usuario['id_personal2']) ? htmlspecialchars($usuario['id_personal2']) : ''; ?>"
  >
  <input 
    type="hidden" 
    id="id_personal" 
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // 🔹 Si ya existe valor (modo edición), se muestra y no se limpia
  if (input.value.trim() !== "") {
    sugerencias.innerHTML = "";
  }
  ...
  input.addEventListener("keyup", () => {
    ...
    // Si el usuario borra todo, limpiar el id oculto
    if (texto.length === 0) {
      idPersonal.value = "";
      sugerencias.innerHTML = "";
      return;
...
<div class="col-sm-12">
  ...
  <input 
    ...
    value="<?php echo isset($usuario['nombre2']) ? htmlspecialchars($usuario['nombre2']) : ''; ?>"
  >
  <div class="invalid-feedback">Se requiere un nombre válido.</div>
  <div class="valid-feedback">Looks good!</div>
</div>
    ...
    <div class="col-sm-6">
  <label for="lastNames" class="form-label">Apellido Paterno:</label>
  <input 
    type="text" 
    class="form-control" 
    id="lastName" 
    ...
    oninput="validateInput(this)" 
    required
    value="<?php echo isset($usuario['apellidoPaterno2']) ? htmlspecialchars($usuario['apellidoPaterno2']) : ''; ?>"
  >
  <div class="invalid-feedback">Se requiere un apellido paterno válido.</div>
    ...
    <div class="col-sm-6">
  <label for="secondLastNames" class="form-label">Apellido Materno:</label>
  <input 
    type="text" 
    class="form-control" 
    id="secondLastName" 
    ...
    required
    oninput="validateInput(this)"
    value="<?php echo isset($usuario['apellidoMaterno2']) ? htmlspecialchars($usuario['apellidoMaterno2']) : ''; ?>"
  >
...
<div class="col-sm-6">
  <label for="birthdate2" class="form-label">Fecha de Nacimiento:</label>
  <input 
    type="date" 
    class="form-control" 
    id="birthdate2" 
    ...
    value="<?php echo !empty($usuario['fechaNacimiento2']) ? htmlspecialchars($usuario['fechaNacimiento2']) : ''; ?>"
  >
  
  <?php if (empty(!$usuario['fechaNacimiento2'])): ?>
    <small class="text-muted">Sin datos</small>
  <?php endif; ?>
...
<div class="col-sm-6">
  ...
  <input 
    ...
    id="age2" 
    name="edad2" 
    value="<?php echo isset($usuario['edad2']) ? htmlspecialchars($usuario['edad2']) : ''; ?>" 
    placeholder="La edad aparecerá aquí"
  >
  <?php if (empty($usuario['edad2'])): ?>
    <small class="text-muted">Sin datos</small>
  <?php endif; ?>
  <div class="invalid-feedback">Se requiere una edad válida.</div>
</div>
  ...
  <div class="col-sm-6">
  <label for="fecharegistro" class="form-label">Fecha y hora de registro:</label>
  <input 
    type="datetime-local" 
    class="form-control" 
    id="fecharegistro" 
    ...
    value="<?php
      ...
      if (empty($usuario['fecharegistro2'])) {
        echo htmlspecialchars(date('Y-m-d\TH:i', strtotime($usuario['fecharegistro2'])));
      } else {
        echo date('Y-m-d\TH:i');
      }
    ?>"
  >
  <?php if (empty($usuario['fecharegistro2'])): ?>
    <small class="text-muted">Sin datos (se usó la fecha y hora actual por defecto)</small>
  <?php endif; ?>
  <div class="invalid-feedback">Se requiere una fecha y hora de registro válidas.</div>
</div>
...
<div class="col-sm-6 position-relative">
  <label for="lugarNacimiento2" class="form-label">Lugar de Nacimiento</label>
  <input 
    type="text" 
    class="form-control" 
    id="lugarNacimiento2" 
    name="lugarNacimiento2" 
    placeholder="Escribe o selecciona un Municipio ..." 
    autocomplete="off"
    value="<?php echo !empty($usuario['lugarNacimiento2']) ? htmlspecialchars($usuario['lugarNacimiento2']) : 'SIN DATOS'; ?>"
  >
  <div class="sugerencias" id="sug_lugarNacimiento2" style="border:1px solid #ccc; max-height:150px; overflow-y:auto;"></div>
  <input 
    type="hidden" 
    id="selected_lugar_id2" 
    name="selected_lugar_id2"
    value="<?php echo isset($usuario['selected_lugar_id2']) ? htmlspecialchars($usuario['selected_lugar_id2']) : ''; ?>"
  >
  <div class="invalid-feedback">Se requiere un Municipio válido.</div>
</div>

<?php
require_once __DIR__ . '/../db/configoaxaca.php'; // Ajusta si la ruta es distinta

$stmt2 = $pdo->query("SELECT id_municipio_inegi, nombre FROM municipios ORDER BY nombre ASC");
$municipios2 = $stmt2->fetchAll();

$municipios_json2 = json_encode($municipios2);
?>

<script>
const input2 = document.getElementById('lugarNacimiento2');
const sugBox2 = document.getElementById('sug_lugarNacimiento2');
const hiddenId2 = document.getElementById('selected_lugar_id2');

// Municipios cargados desde PHP
const municipios2 = <?php echo $municipios_json2; ?>;

// Si el valor inicial es "Sin datos", limpiar al hacer clic
input2.addEventListener('focus', () => {
  if (input2.value.trim().toLowerCase() === 'sin datos') {
    input2.value = '';
  }
});
...
input2.addEventListener('input', function() {
    ...
    const filtered = municipios2.filter(m => m.nombre.toLowerCase().includes(val));

    if (filtered.length === 0) {
        sugBox2.innerHTML = '<div style="padding:5px;">No hay coincidencias</div>';
        hiddenId2.value = '';
        return;
    }
    ...
    filtered.forEach(m => {
        ...
        div.style.cursor = 'pointer';
        div.addEventListener('click', () => {
            input2.value = m.nombre;
            hiddenId2.value = m.id_municipio_inegi;
            sugBox2.innerHTML = '';
        });
        sugBox2.appendChild(div);
    });
});

// Ocultar sugerencias al perder foco
input2.addEventListener('blur', () => {
    setTimeout(() => { sugBox2.innerHTML = ''; }, 150);
});
</script>
  ...
  <select class="form-select" id="sexo2" name="sexo2" aria-label="Selecciona una opción" required>
    <option disabled value="">Selecciona una opción...</option>
    <option value="SIN DATOS" <?php echo (empty($usuario['sexo2']) || $usuario['sexo2'] === 'SIN DATOS') ? 'selected' : ''; ?>>SIN DATOS</option>
    <option value="MASCULINO" <?php echo (isset($usuario['sexo2']) && $usuario['sexo2'] === 'MASCULINO') ? 'selected' : ''; ?>>MASCULINO</option>
    <option value="FEMENINO" <?php echo (isset($usuario['sexo2']) && $usuario['sexo2'] === 'FEMENINO') ? 'selected' : ''; ?>>FEMENINO</option>
    <option value="OTRO" <?php echo (isset($usuario['sexo2']) && $usuario['sexo2'] === 'OTRO') ? 'selected' : ''; ?>>OTRO</option>
  </select>
  <div class="invalid-feedback">Se requiere una selección válida.</div>
</div>
  ...
  <!-- Opción SIN DATOS -->
  <div class="form-check">
    <input class="form-check-input" type="radio" name="indigena2" id="indigenaSinDatos"
      value="SIN DATOS" <?php echo (empty($usuario['indigena2']) || $usuario['indigena2'] === 'SIN DATOS') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="indigenaSinDatos">SIN DATOS</label>
  </div>

  <!-- Opción SI -->
  <div class="form-check">
    <input class="form-check-input" type="radio" name="indigena2" id="indigenaopcion1"
      value="SI" <?php echo (isset($usuario['indigena2']) && $usuario['indigena2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="indigenaopcion1">SI</label>
  </div>

  <!-- Opción NO -->
  <div class="form-check">
    <input class="form-check-input" type="radio" name="indigena2" id="indigenaopcion2"
      value="NO" <?php echo (isset($usuario['indigena2']) && $usuario['indigena2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="indigenaopcion2">NO</label>
  </div>
</div>
   ...
   <div class="col-sm-6">
  <label for="lenguaMaterna" class="form-label">Lengua Materna</label>
  <select class="form-select" id="lenguaMaterna" name="lenguaMaterna2" required>
    <option value="">Selecciona una lengua materna</option>
    <option value="SIN DATOS" <?php echo (empty($usuario['lenguaMaterna2']) || $usuario['lenguaMaterna2'] === 'SIN DATOS') ? 'selected' : ''; ?>>SIN DATOS</option>
    <option value="Español" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Español') ? 'selected' : ''; ?>>Español</option>
    <option value="Zapoteco" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Zapoteco') ? 'selected' : ''; ?>>Zapoteco</option>
    <option value="Mixteco" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Mixteco') ? 'selected' : ''; ?>>Mixteco</option>
    <option value="Mazateco" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Mazateco') ? 'selected' : ''; ?>>Mazateco</option>
    <option value="Triqui" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Triqui') ? 'selected' : ''; ?>>Triqui</option>
    <option value="Cuicateco" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Cuicateco') ? 'selected' : ''; ?>>Cuicateco</option>
    <option value="Chontal de Oaxaca" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Chontal de Oaxaca') ? 'selected' : ''; ?>>Chontal de Oaxaca</option>
    <option value="Chinanteco" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Chinanteco') ? 'selected' : ''; ?>>Chinanteco</option>
    <option value="Ixcateco" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Ixcateco') ? 'selected' : ''; ?>>Ixcateco</option>
    <option value="Huave" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Huave') ? 'selected' : ''; ?>>Huave</option>
    <option value="Mixe" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Mixe') ? 'selected' : ''; ?>>Mixe</option>
    <option value="Trique" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Trique') ? 'selected' : ''; ?>>Trique</option>
    <option value="Zoque de Oaxaca" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Zoque de Oaxaca') ? 'selected' : ''; ?>>Zoque de Oaxaca</option>
    <option value="Amuzgo" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Amuzgo') ? 'selected' : ''; ?>>Amuzgo</option>
    <option value="Otros" <?php echo (isset($usuario['lenguaMaterna2']) && $usuario['lenguaMaterna2'] === 'Otros') ? 'selected' : ''; ?>>Otros</option>
  </select>
  <div class="invalid-feedback">Se requiere una lengua materna válida.</div>
</div>
  ...
  <div class="form-check">
    <input 
      ...
      type="radio" 
      name="hablaLenguaIndigena2" 
      id="exampleRadios1" 
      value="SI" 
      onclick="showLanguageSelect()" 
      <?php echo (isset($usuario['hablaLenguaIndigena2']) && $usuario['hablaLenguaIndigena2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input 
      ...
      id="exampleRadios2" 
      value="NO" 
      onclick="hideLanguageSelect()" 
      <?php echo (isset($usuario['hablaLenguaIndigena2']) && $usuario['hablaLenguaIndigena2'] === 'NO') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input 
      ...
      value="SIN DATOS"
      onclick="hideLanguageSelect()" 
      <?php echo (empty($usuario['hablaLenguaIndigena2']) || $usuario['hablaLenguaIndigena2'] === 'SIN DATOS') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="exampleRadios3">Sin datos</label>
  </div>
</div>

<div 
  class="col-sm-6" 
  id="languageSelectContainer2" 
  style="display: <?php echo (isset($usuario['hablaLenguaIndigena2']) && $usuario['hablaLenguaIndigena2'] === 'SI') ? 'block' : 'none'; ?>;">
  <label for="lenguaIndigena2" class="form-label">¿Cuál?</label>
  <select class="form-select" id="lenguaIndigena2" name="lenguaIndigena2">
    <option value="">Seleccionar lengua...</option>
    <option value="SIN DATOS" <?php echo (empty($usuario['lenguaIndigena2']) || $usuario['lenguaIndigena2'] === 'SIN DATOS') ? 'selected' : ''; ?>>SIN DATOS</option>
    <option value="Zapoteco" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Zapoteco') ? 'selected' : ''; ?>>Zapoteco</option>
    <option value="Mixteco" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Mixteco') ? 'selected' : ''; ?>>Mixteco</option>
    <option value="Mazateco" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Mazateco') ? 'selected' : ''; ?>>Mazateco</option>
    <option value="Chinanteco" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Chinanteco') ? 'selected' : ''; ?>>Chinanteco</option>
    <option value="Mixe" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Mixe') ? 'selected' : ''; ?>>Mixe</option>
    <option value="Triqui" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Triqui') ? 'selected' : ''; ?>>Triqui</option>
    <option value="Chatino" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Chatino') ? 'selected' : ''; ?>>Chatino</option>
    <option value="Amuzgo" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Amuzgo') ? 'selected' : ''; ?>>Amuzgo</option>
    <option value="Cuicateco" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Cuicateco') ? 'selected' : ''; ?>>Cuicateco</option>
    <option value="Trique" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Trique') ? 'selected' : ''; ?>>Trique</option>
    <option value="Huave" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Huave') ? 'selected' : ''; ?>>Huave</option>
    <option value="Chontal" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Chontal') ? 'selected' : ''; ?>>Chontal</option>
    <option value="Ixcateco" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Ixcateco') ? 'selected' : ''; ?>>Ixcateco</option>
    <option value="Zoque" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Zoque') ? 'selected' : ''; ?>>Zoque</option>
    <option value="Náhuatl" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Náhuatl') ? 'selected' : ''; ?>>Náhuatl</option>
    <option value="Otros" <?php echo (isset($usuario['lenguaIndigena2']) && $usuario['lenguaIndigena2'] === 'Otros') ? 'selected' : ''; ?>>Otros</option>
  </select>
</div>

<script>
  function showLanguageSelect() {
    document.getElementById('languageSelectContainer2').style.display = 'block';
  }

  function hideLanguageSelect() {
    document.getElementById('languageSelectContainer2').style.display = 'none';
    document.getElementById('lenguaIndigena2').value = ''; // Limpia selección
  }
</script>
 ...
 <h4>Datos de Contacto</h4>
            <hr class="my-4">
             ...
             <div class="col-sm-6">
  <label for="telFijo2" class="form-label">Teléfono fijo</label>
  <input 
    type="number" 
    class="form-control" 
    id="telFijo2" 
    name="telFijo2" 
    placeholder="No Existe un Numero Ingrese su número de teléfono fijo"
    value="<?php echo !empty($usuario['telFijo2']) ? htmlspecialchars($usuario['telFijo2']) : ''; ?>">
  
  <?php if (empty($usuario['telFijo2'])): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
  ...
  <div class="invalid-feedback">Se requiere un número de teléfono fijo válido.</div>
   ...
   <div class="col-sm-6">
  <label for="telCelular2" class="form-label">Teléfono celular</label>
  <input 
    type="number" 
    class="form-control" 
    id="telCelular2" 
    name="telCelular2" 
    placeholder="No Existe un Numero Ingrese su número de teléfono celular"
    value="<?php echo !empty($usuario['telCelular2']) ? htmlspecialchars($usuario['telCelular2']) : ''; ?>">
  
  <?php if (empty($usuario['telCelular2'])): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
  ...
  <div class="input-group has-validation">
    ...
    <input 
      ...
      value="<?php echo !empty($usuario['email2']) ? htmlspecialchars($usuario['email2']) : ''; ?>">
    <div class="invalid-feedback">Se requiere una dirección de correo electrónico válida.</div>
  </div>

  <?php if (empty($usuario['email2'])): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
</div>
   ...
   <div class="col-sm-6">
  <label for="emailRespaldo2" class="form-label">
    Correo electrónico de respaldo <span class="text-body-secondary">(Opcional)</span>
  </label>
  <div class="input-group has-validation">
    <span class="input-group-text">@</span>
    <input 
      ...
      name="emailRespaldo2" 
      placeholder="Correo electrónico"
      value="<?php echo !empty($usuario['emailRespaldo2']) ? htmlspecialchars($usuario['emailRespaldo2']) : ''; ?>">
  </div>

  <?php if (empty($usuario['emailRespaldo2'])): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
</div>
...
<div class="col-sm-6">
  ...
  <input 
    ...
    name="telConfianza2" 
    placeholder="" 
    value="<?php echo isset($usuario['telConfianza']) && !empty($usuario['telConfianza']) ? htmlspecialchars($row['telConfianza']) : ''; ?>"
  >
  <span id="sinDatosTelConfianza" class="text-muted" style="display:none;">SIN DATOS</span>
  <div class="invalid-feedback">Se requiere un número de teléfono de confianza válido.</div>
</div>

<script>
  const telConfianzaInput = document.getElementById('telConfianza');
  const sinDatosTelConfianza = document.getElementById('sinDatosTelConfianza');

  if (!telConfianzaInput.value) {
    telConfianzaInput.style.display = 'none';
    sinDatosTelConfianza.style.display = 'inline';
  } else {
    telConfianzaInput.style.display = 'block';
    sinDatosTelConfianza.style.display = 'none';
  }
</script>
...
<div class="col-sm-6">
  ...
  <input 
    ...
    class="form-control" 
    id="firstname" 
    name="nombreconfianza2" 
    placeholder=""
    value="<?php echo isset($usuario['nombreconfianza2']) && !empty($usuario['nombreconfianza2']) ? htmlspecialchars($row['nombreconfianza']) : 'SIN DATOS'; ?>"
  >
  <div class="invalid-feedback">Se requiere un nombre de confianza válido.</div>
</div>
...
<div class="col-sm-6">
  ...
  <select class="form-select" id="parentesco" name="parentesco2">
    <?php
      $parentesco = isset($usuario['parentesco2']) && !empty($usuario['parentesco2']) ? $usuario['parentesco2'] : 'SIN DATOS';
    ?>
    <option value="SIN DATOS" <?php echo $parentesco == 'SIN DATOS' ? 'selected' : ''; ?>>SIN DATOS</option>
    ...
    <option value="hermano" <?php echo $parentesco == 'hermano' ? 'selected' : ''; ?>>Hermano</option>
    <option value="hermana" <?php echo $parentesco == 'hermana' ? 'selected' : ''; ?>>Hermana</option>
    <option value="tio" <?php echo $parentesco == 'tio' ? 'selected' : ''; ?>>Tío</option>
    <option value="tia" <?php echo $parentesco == 'tia' ? 'selected' : ''; ?>>Tía</option>
    <option value="abuelo" <?php echo $parentesco == 'abuelo' ? 'selected' : ''; ?>>Abuelo</option>
    <option value="abuela" <?php echo $parentesco == 'abuela' ? 'selected' : ''; ?>>Abuela</option>
    <option value="amigo" <?php echo $parentesco == 'amigo' ? 'selected' : ''; ?>>Amigo/a</option>
 ...
 <h4>Datos de Orientacion Social</h4>
  ...
  <?php
    $comunidadLGBT = isset($usuario['comunidadLGBT2']) && !empty($usuario['comunidadLGBT2']) ? $usuario['comunidadLGBT2'] : 'SIN DATOS';
    $tipoLgbt = isset($usuario['tipoLgbt2']) && !empty($usuario['tipoLgbt2']) ? $usuario['tipoLgbt2'] : '';
  ?>
  ...
  <div class="form-check">
    <input 
      ...
      value="SIN DATOS" 
      onclick="hideLgbtSelect()" 
      <?php echo ($comunidadLGBT == 'SIN DATOS') ? 'checked' : ''; ?>
    >
    <label class="form-check-label" for="lgbtSinDatos">SIN DATOS</label>
  </div>
</div>

<div 
  class="col-sm-6" 
  id="lgbtSelectContainer2" 
  style="display: <?php echo ($comunidadLGBT == 'SI') ? 'block' : 'none'; ?>;"
>
  <label for="tipoLgbt2" class="form-label">¿A cuál?</label>
  <select class="form-select" id="tipoLgbt2" name="tipoLgbt2">
...
<script>
  function showLgbtSelect() {
    document.getElementById('lgbtSelectContainer2').style.display = 'block';
  }

  function hideLgbtSelect() {
    document.getElementById('lgbtSelectContainer2').style.display = 'none';
    document.getElementById('tipoLgbt2').value = '';
  }
</script>
...
<div class="col-sm-6">
  ...
  <?php
    // Si no hay valor registrado en la base, se muestra "SIN DATOS"
    $estadoCivil = isset($usuario['estadocivil2']) && !empty($usuario['estadocivil2']) ? $usuario['estadocivil2'] : 'SIN DATOS';
  ?>

  <select class="form-select" id="estadoCivil" name="estadocivil2">
    <option value="SIN DATOS" <?php echo ($estadoCivil == 'SIN DATOS') ? 'selected' : ''; ?>>SIN DATOS</option>
    <option value="SOLTERO" <?php echo ($estadoCivil == 'SOLTERO') ? 'selected' : ''; ?>>SOLTERO/A</option>
    <option value="CASADO" <?php echo ($estadoCivil == 'CASADO') ? 'selected' : ''; ?>>CASADO/A</option>
    <option value="DIVORCIADO" <?php echo ($estadoCivil == 'DIVORCIADO') ? 'selected' : ''; ?>>DIVORCIADO/A</option>
    <option value="VIUDO" <?php echo ($estadoCivil == 'VIUDO') ? 'selected' : ''; ?>>VIUDO/A</option>
    <option value="UNION_LIBRE" <?php echo ($estadoCivil == 'UNION_LIBRE') ? 'selected' : ''; ?>>UNIÓN LIBRE</option>
    <option value="SEPARADO" <?php echo ($estadoCivil == 'SEPARADO') ? 'selected' : ''; ?>>SEPARADO/A</option>
    <option value="COMPROMETIDO" <?php echo ($estadoCivil == 'COMPROMETIDO') ? 'selected' : ''; ?>>COMPROMETIDO/A</option>
    <option value="CONCUBINATO" <?php echo ($estadoCivil == 'CONCUBINATO') ? 'selected' : ''; ?>>CONCUBINATO</option>
    <option value="PAREJA_DE_HECHO" <?php echo ($estadoCivil == 'PAREJA_DE_HECHO') ? 'selected' : ''; ?>>PAREJA DE HECHO</option>
    <option value="ANULADO" <?php echo ($estadoCivil == 'ANULADO') ? 'selected' : ''; ?>>MATRIMONIO ANULADO</option>
  ...
  <?php
    // Si no hay datos en la base, muestra "SIN DATOS"
    $calle = isset($usuario['calle2']) && !empty($usuario['calle2']) ? $usuario['calle2'] : 'SIN DATOS';
  ?>
  ...
  <?php
    $numInteriorVacio = empty($usuario['numInterior2']);
  ?>
  ...
  <input 
    ...
    id="numInterior" 
    name="numInterior2" 
    value="<?php echo !$numInteriorVacio ? htmlspecialchars($usuario['numInterior2']) : ''; ?>" 
    placeholder="">

  <?php if ($numInteriorVacio): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
  ...
  <?php
    $numExteriorVacio = empty($usuario['numExterior2']);
  ?>
  ...
  <input 
    ...
    id="numExterior" 
    name="numExterior2" 
    value="<?php echo !$numExteriorVacio ? htmlspecialchars($usuario['numExterior2']) : ''; ?>" 
    placeholder="">

  <?php if ($numExteriorVacio): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
  ...
  <?php
    $estadoValor = !empty($usuario['estado2']) ? htmlspecialchars($usuario['estado2']) : 'SIN DATOS';
  ?>
...
<input type="hidden" id="selected_region_id_tutor">
<input type="hidden" id="selected_distrito_id_tutor">
<input type="hidden" id="selected_municipio_id_tutor">
<input type="hidden" id="selected_localidad_id_tutor"> 



<div class="col-sm-6">
  <label for="cp_tutor" class="form-label">Código Postal (CP)</label>
  <input type="number" max="100000" min="0" class="form-control" id="cp_tutor" name="cp2" 
         value="<?php echo !empty($usuario['cp2']) ? $usuario['cp2'] : ''; ?>">
  
  <!-- Mostrar SIN DATOS si no hay valor -->
  <?php if (empty($usuario['cp2'])): ?>
      <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
...
<div class="col-sm-6">
    <label for="input_region_tutor" class="form-label">Región:</label>
    <input type="text" class="form-control" id="input_region_tutor" name="region2" 
           value="<?php echo !empty($usuario['region2']) ? $usuario['region2'] : 'SIN DATOS'; ?>" autocomplete="off">
    <div class="sugerencias" id="sug_region_tutor"></div>
</div>

<div class="col-sm-6">
    <label for="input_distrito_tutor" class="form-label">Distrito:</label>
    <input type="text" id="input_distrito_tutor" class="form-control" 
           autocomplete="off">
    <div class="sugerencias" id="sug_distrito_tutor"></div>
</div>

<div class="col-sm-6">
    <label for="input_municipio_tutor" class="form-label">Municipio:</label>
    <input type="text" id="input_municipio_tutor" class="form-control" name="municipio2" 
           value="<?php echo !empty($usuario['municipio2']) ? $usuario['municipio2'] : 'SIN DATOS'; ?>" autocomplete="off">
    <div class="sugerencias" id="sug_municipio_tutor"></div>
</div>

<div class="col-sm-6">
    <label for="input_localidad_tutor" class="form-label">Localidad:</label>
    <input type="text" id="input_localidad_tutor" class="form-control" name="colonia2" 
           value="<?php echo !empty($usuario['colonia2']) ? $usuario['colonia2'] : 'SIN DATOS'; ?>" 
           placeholder="Escribe el nombre de la localidad..." autocomplete="off">
    <div class="sugerencias" id="sug_localidad_tutor"></div>
</div>

</div>

<div id="detalles_tutor" style="display: none;">
    <p><strong>Localidad:</strong> <span id="res_localidad_tutor"></span></p>
    <p><strong>Municipio:</strong> <span id="res_municipio_tutor"></span></p>
    <p><strong>Distrito:</strong> <span id="res_distrito_tutor"></span></p>
    <p><strong>Región:</strong> <span id="res_region_tutor"></span></p>
</div>
...
<script>
// --- Referencias a los elementos para tutor ---
const inputs_tutor = {
    region: document.getElementById('input_region_tutor'),
    distrito: document.getElementById('input_distrito_tutor'),
    municipio: document.getElementById('input_municipio_tutor'),
    localidad: document.getElementById('input_localidad_tutor')
};
const suggestions_tutor = {
    region: document.getElementById('sug_region_tutor'),
    distrito: document.getElementById('sug_distrito_tutor'),
    municipio: document.getElementById('sug_municipio_tutor'),
    localidad: document.getElementById('sug_localidad_tutor')
};
const selectedIds_tutor = {
    region: document.getElementById('selected_region_id_tutor'),
    distrito: document.getElementById('selected_distrito_id_tutor'),
    municipio: document.getElementById('selected_municipio_id_tutor'),
    localidad: document.getElementById('selected_localidad_id_tutor') // Añadido
};

// --- LÓGICA DE BÚSQUEDA (keyup) ---
inputs_tutor.region.addEventListener('keyup', e => handleSearchTutor('region', e.target.value));
inputs_tutor.distrito.addEventListener('keyup', e => handleSearchTutor('distrito', e.target.value));
inputs_tutor.municipio.addEventListener('keyup', e => handleSearchTutor('municipio', e.target.value));
inputs_tutor.localidad.addEventListener('keyup', e => handleSearchTutor('localidad', e.target.value));

async function handleSearchTutor(type, query) {
    if (query.length < 2) {
        suggestions_tutor[type].innerHTML = '';
        if (query.length === 0 && selectedIds_tutor[type]) {
            selectedIds_tutor[type].value = '';
            resetChildrenTutor(type);
        }
        return;
    }
    ...
    if (type === 'distrito' && selectedIds_tutor.region.value) {
        params.append('region_id', selectedIds_tutor.region.value);
    }
    if (type === 'municipio') {
        if (selectedIds_tutor.distrito.value) params.append('distrito_id', selectedIds_tutor.distrito.value);
        else if (selectedIds_tutor.region.value) params.append('region_id', selectedIds_tutor.region.value);
    }
    if (type === 'localidad') {
        if (selectedIds_tutor.municipio.value) params.append('municipio_id', selectedIds_tutor.municipio.value);
        else if (selectedIds_tutor.distrito.value) params.append('distrito_id', selectedIds_tutor.distrito.value);
        else if (selectedIds_tutor.region.value) params.append('region_id', selectedIds_tutor.region.value);
    }
    ...
    try {
        ...
        if (data.error) {
            console.error("Error del backend:", data.error);
            suggestions_tutor[type].innerHTML = `<div>Error: ${data.error}</div>`;
        } else {
            mostrarSugerenciasTutor(type, data);
        }
    } catch (error) {
        console.error("Error en fetch o procesando JSON:", error);
        suggestions_tutor[type].innerHTML = `<div>Error al buscar: ${error.message}</div>`;
    }
}

function mostrarSugerenciasTutor(type, data) {
    const sugBox = suggestions_tutor[type];
    sugBox.innerHTML = '';
    ...
    data.forEach(item => {
        ...
        if (id_value !== undefined && id_value !== null) {
            div.addEventListener('click', () => handleSuggestionClickTutor(type, item, id_value));
        } else {
            console.warn("Item sin ID válido encontrado:", item);
        }
        sugBox.appendChild(div);
    });
}

async function handleSuggestionClickTutor(type, itemData, id) {
    Object.values(suggestions_tutor).forEach(sug => sug.innerHTML = '');
    document.getElementById('detalles_tutor').style.display = 'none';
    inputs_tutor[type].value = itemData.nombre;
    if (selectedIds_tutor[type]) selectedIds_tutor[type].value = id;
    resetChildrenTutor(type);
    await fetchFullDetailsTutor(type, id);
}

async function fetchFullDetailsTutor(type, id) {
    const paramName = (type === 'localidad') ? 'localidad_id' : `${type}_id`;
    try {
        const response = await fetch(`./api.php?type=get_full_details&${paramName}=${id}`);
        if (!response.ok) throw new Error(`Error ${response.status}: ${response.statusText}`);
        const details = await response.json();
        if (details.error) console.error("Error del backend en get_full_details:", details.error);
        else populateFieldsTutor(details);
    } catch (error) {
        console.error("Error en fetchFullDetailsTutor:", error);
    }
}

function populateFieldsTutor(details) {
    console.log("Datos recibidos para rellenar tutor:", details);

    if (details.region_id !== undefined && details.region_nombre !== undefined) {
        inputs_tutor.region.value = details.region_nombre || '';
        selectedIds_tutor.region.value = details.region_id || '';
    } else { inputs_tutor.region.value = ''; selectedIds_tutor.region.value = ''; }

    if (details.distrito_id !== undefined && details.distrito_nombre !== undefined) {
        inputs_tutor.distrito.value = details.distrito_nombre || '';
        selectedIds_tutor.distrito.value = details.distrito_id || '';
    } else { inputs_tutor.distrito.value = ''; selectedIds_tutor.distrito.value = ''; }

    if (details.municipio_id !== undefined && details.municipio_nombre !== undefined) {
        inputs_tutor.municipio.value = details.municipio_nombre || '';
        selectedIds_tutor.municipio.value = details.municipio_id || '';
    } else { inputs_tutor.municipio.value = ''; selectedIds_tutor.municipio.value = ''; }

    if (details.localidad_id !== undefined && details.localidad_nombre !== undefined) {
        inputs_tutor.localidad.value = details.localidad_nombre || '';
        selectedIds_tutor.localidad.value = details.localidad_id || '';
    } else { inputs_tutor.localidad.value = ''; selectedIds_tutor.localidad.value = ''; }

    if (details.codigo_postal !== undefined && details.codigo_postal !== null) {
        document.getElementById('cp_tutor').value = details.codigo_postal;
    } else {
        document.getElementById('cp_tutor').value = '';
    }

    if (details.localidad_id !== null && details.localidad_id !== undefined) {
        document.getElementById('res_localidad_tutor').textContent = details.localidad_nombre || 'N/A';
        document.getElementById('res_municipio_tutor').textContent = details.municipio_nombre || 'N/A';
        document.getElementById('res_distrito_tutor').textContent = details.distrito_nombre || 'N/A';
        document.getElementById('res_region_tutor').textContent = details.region_nombre || 'N/A';
        let detallesExtra = '';
        if (details.tipo_asentamiento) detallesExtra += ` (${details.tipo_asentamiento})`;
        if (details.codigo_postal) detallesExtra += ` - CP: ${details.codigo_postal}`;
        document.getElementById('res_localidad_tutor').textContent += detallesExtra;
        document.getElementById('detalles_tutor').style.display = 'block';
    } else {
        document.getElementById('detalles_tutor').style.display = 'none';
    }
}

function resetChildrenTutor(typeChanged) {
    console.log(`Reseteando hijos de tutor: ${typeChanged}`);
    document.getElementById('detalles_tutor').style.display = 'none';
    const hierarchy = ['region', 'distrito', 'municipio', 'localidad'];
    const startIndex = hierarchy.indexOf(typeChanged);
    if (startIndex > -1 && startIndex < hierarchy.length - 1) {
        for (let i = startIndex + 1; i < hierarchy.length; i++) {
            const childType = hierarchy[i];
            if (inputs_tutor[childType]) inputs_tutor[childType].value = '';
            if (selectedIds_tutor[childType]) selectedIds_tutor[childType].value = '';
            if (suggestions_tutor[childType]) suggestions_tutor[childType].innerHTML = '';
        }
    }
}

function resetFieldsTutor() {
    Object.values(inputs_tutor).forEach(input => input.value = '');
    Object.values(selectedIds_tutor).forEach(hidden => hidden.value = '');
    Object.values(suggestions_tutor).forEach(sug => sug.innerHTML = '');
    document.getElementById('detalles_tutor').style.display = 'none';
    console.log("Todos los campos de tutor reseteados.");
}
...
<div class="col-sm-6">
  <label class="form-label">¿PERTENECE A UN GRUPO ÉTNICO?</label>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="perteneceEtnico2" id="etnicoSi" value="SI" 
           onclick="showEtnicoSelect()" 
           <?php echo (isset($usuario['perteneceEtnico2']) && $usuario['perteneceEtnico2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="etnicoSi">SÍ</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="perteneceEtnico2" id="etnicoNo" value="NO" 
           onclick="hideEtnicoSelect()" 
           <?php echo (isset($usuario['perteneceEtnico2']) && $usuario['perteneceEtnico2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="etnicoNo">NO</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="perteneceEtnico2" id="etnicoNoEspecificado" value="NO ESPECIFICADO" 
           onclick="hideEtnicoSelect()" 
           <?php 
             echo (!isset($usuario['perteneceEtnico2']) || $usuario['perteneceEtnico2'] === '' || $usuario['perteneceEtnico2'] === 'NO ESPECIFICADO') 
                  ? 'checked' : ''; 
           ?>>
    <label class="form-check-label" for="etnicoNoEspecificado">NO ESPECIFICADO</label>
  </div>
</div>

<div class="col-sm-6" id="etnicoSelectContainer2" 
     style="display: <?php echo (isset($usuario['perteneceEtnico2']) && $usuario['perteneceEtnico2'] === 'SI') ? 'block' : 'none'; ?>;">
  <label for="grupoEtnico2" class="form-label">¿A CUÁL?</label>
  <select class="form-select" id="grupoEtnico2" name="grupoEtnico2">
    <option disabled value="">SELECCIONAR GRUPO ÉTNICO...</option>
    <?php 
      $etnicos = ['ZAPOTECO','MIXTECO','MAZATECO','CHINANTECO','MIXE','TRIQUI','CHATINO',
                  'AMUZGO','CUICATECO','HUAVE','CHONTAL','IXCATECO','ZOQUE','NÁHUATL','OTRO'];
      $seleccion = isset($usuario['grupoEtnico2']) && $usuario['grupoEtnico2'] !== '' ? $usuario['grupoEtnico2'] : '';
      foreach($etnicos as $etnico){
          $selected = ($etnico === $seleccion) ? 'selected' : '';
          echo "<option value='$etnico' $selected>$etnico</option>";
      }
      // Mostrar SIN DATOS si no hay selección
      if($seleccion === '') {
          echo "<option selected disabled value=''>SIN DATOS</option>";
      }
    ?>
  </select>
</div>
...
<script>
  function showEtnicoSelect() {
    document.getElementById('etnicoSelectContainer2').style.display = 'block';
  }

  function hideEtnicoSelect() {
    document.getElementById('etnicoSelectContainer2').style.display = 'none';
    document.getElementById('grupoEtnico2').value = ''; // Limpia la selección
  }
</script>
...
<div class="col-sm-6">
  <label class="form-label">¿SU PADRE O MADRE HABLA ALGUNA LENGUA INDÍGENA?</label>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="padresLengua2" id="padresLenguaSi" value="SI" 
           onclick="showPadresLenguaSelect()"
           <?php echo (isset($usuario['padresLengua2']) && $usuario['padresLengua2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="padresLenguaSi">SÍ</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="padresLengua2" id="padresLenguaNo" value="NO" 
           onclick="hidePadresLenguaSelect()"
           <?php echo (isset($usuario['padresLengua2']) && $usuario['padresLengua2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="padresLenguaNo">NO</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="padresLengua2" id="padresLenguaNoEspecificado" value="NO ESPECIFICADO" 
           onclick="hidePadresLenguaSelect()"
           <?php 
             echo (!isset($usuario['padresLengua2']) || $usuario['padresLengua2'] === '' || $usuario['padresLengua2'] === 'NO ESPECIFICADO') 
                  ? 'checked' : ''; 
           ?>>
    <label class="form-check-label" for="padresLenguaNoEspecificado">NO ESPECIFICADO</label>
  </div>
</div>

<div class="col-sm-6" id="padresLenguaSelectContainer2" 
     style="display: <?php echo (isset($usuario['padresLengua2']) && $usuario['padresLengua2'] === 'SI') ? 'block' : 'none'; ?>;">
  <label for="lenguaPadres2" class="form-label">¿CUÁL?</label>
  <select class="form-select" id="lenguaPadres2" name="lenguaPadres2">
    <option disabled value="">SELECCIONAR LENGUA...</option>
    <?php 
      $lenguas = ['ZAPOTECO','MIXTECO','MAZATECO','CHINANTECO','MIXE','TRIQUI','CHATINO',
                  'AMUZGO','CUICATECO','HUAVE','CHONTAL','IXCATECO','ZOQUE','NÁHUATL','OTRO'];
      $seleccion = isset($usuario['lenguaPadres2']) && $usuario['lenguaPadres2'] !== '' ? $usuario['lenguaPadres2'] : '';
      foreach($lenguas as $lengua){
          $selected = ($lengua === $seleccion) ? 'selected' : '';
          echo "<option value='$lengua' $selected>$lengua</option>";
      }
      // Mostrar SIN DATOS si no hay selección
      if($seleccion === '') {
...
<script>
  function showPadresLenguaSelect() {
    document.getElementById('padresLenguaSelectContainer2').style.display = 'block';
  }

  function hidePadresLenguaSelect() {
    document.getElementById('padresLenguaSelectContainer2').style.display = 'none';
    document.getElementById('lenguaPadres2').value = ''; // Limpia la selección
  }
</script>
...
<div class="col-sm-6">
  <label for="aniosOaxaca" class="form-label">AÑOS DE VIVIR EN OAXACA</label>
  <input type="text" class="form-control" id="aniosOaxaca" name="aniosOaxaca2" 
         value="<?php echo isset($usuario['aniosOaxaca2']) && $usuario['aniosOaxaca2'] !== '' ? $usuario['aniosOaxaca2'] : ''; ?>"
         placeholder="<?php echo (!isset($usuario['aniosOaxaca2']) || $usuario['aniosOaxaca2'] === '') ? 'SIN DATOS' : ''; ?>"
...
<div class="col-sm-6" class="row mt-2">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="asiste_escuela2" id="escuelaSi" value="SI" 
           onclick="mostrarCamposEscuela(true)"
           <?php echo (isset($usuario['asiste_escuela2']) && $usuario['asiste_escuela2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="escuelaSi">Sí</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="asiste_escuela2" id="escuelaNo" value="NO" 
           onclick="mostrarCamposEscuela(false)"
           <?php echo (isset($usuario['asiste_escuela2']) && $usuario['asiste_escuela2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="escuelaNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="asiste_escuela2" id="escuelaNoEspecificado" value="NO ESPECIFICADO"
           onclick="mostrarCamposEscuela(false)"
           <?php echo (!isset($usuario['asiste_escuela2']) || $usuario['asiste_escuela2']==='' || $usuario['asiste_escuela2']==='NO ESPECIFICADO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="escuelaNoEspecificado">NO ESPECIFICADO</label>
  </div>
</div>

<div id="camposEscuela" class="row mt-2" 
     style="display: <?php echo (isset($usuario['asiste_escuela2']) && $usuario['asiste_escuela2']==='SI') ? 'flex' : 'none'; ?>; flex-wrap: wrap;">
  ...
  <div class="col-sm-6">
    ...
    <select class="form-select" id="escolaridad" name="escolaridad2" aria-label="Selecciona una opción">
        <option disabled value="">Selecciona una opción...</option>
        <?php 
        $opciones = ['NINGUNA','PRIMARIA TERMINADA','PRIMARIA TRUNCA','SECUNDARIA TERMINADA','SECUNDARIA TRUNCA',
                     'PREPARATORIA TERMINADA','PREPARATORIA TRUNCA','UNIVERSIDAD TERMINADA','UNIVERSIDAD TRUNCA','POSTGRADO'];
        $seleccion = isset($usuario['escolaridad2']) && $usuario['escolaridad2'] !== '' ? $usuario['escolaridad2'] : '';
        foreach($opciones as $opcion){
            $selected = ($opcion === $seleccion) ? 'selected' : '';
  ...
  <div class="col-sm-6">
    ...
    <input type="text" class="form-control" name="escuela_actual2" 
           value="<?php echo isset($usuario['escuela_actual2']) && $usuario['escuela_actual2'] !== '' ? $usuario['escuela_actual2'] : 'SIN DATOS'; ?>">
  </div>

  <div class="col-sm-6">
    <label class="form-label">Grado escolar</label>
    <input type="text" class="form-control" name="grado_escolar2" 
           value="<?php echo isset($usuario['grado_escolar2']) && $usuario['grado_escolar2'] !== '' ? $usuario['grado_escolar2'] : 'SIN DATOS'; ?>">
  </div>

  <div class="col-sm-6 mt-3">
    <label class="form-label">¿Cómo te sientes en la escuela?</label>
    <input type="text" class="form-control" name="sentimiento_escuela2" 
           value="<?php echo isset($usuario['sentimiento_escuela2']) && $usuario['sentimiento_escuela2'] !== '' ? $usuario['sentimiento_escuela2'] : 'SIN DATOS'; ?>">
  </div>

  <div class="col-sm-6 mt-3">
    <label class="form-label">¿Qué materias te gustan más?</label>
    <input type="text" class="form-control" name="materias_gustan2" 
           value="<?php echo isset($usuario['materias_gustan2']) && $usuario['materias_gustan2'] !== '' ? $usuario['materias_gustan2'] : 'SIN DATOS'; ?>">
  </div>

  <div class="col-sm-6 mt-3">
    <label class="form-label">¿Tienes dificultades escolares?</label>
    <div class="form-check">
      <input class="form-check-input" type="radio" name="dificultades2" id="dificultadesSi" value="SI" 
             onclick="mostrarDescripcionDificultad(true)"
             <?php echo (isset($usuario['dificultades2']) && $usuario['dificultades2']==='SI') ? 'checked' : ''; ?>>
      <label class="form-check-label" for="dificultadesSi">Sí</label>
    </div>
    <div class="form-check">
      <input class="form-check-input" type="radio" name="dificultades2" id="dificultadesNo" value="NO" 
             onclick="mostrarDescripcionDificultad(false)"
             <?php echo (isset($usuario['dificultades2']) && $usuario['dificultades2']==='NO') ? 'checked' : ''; ?>>
      <label class="form-check-label" for="dificultadesNo">No</label>
    </div>
    <div class="form-check">
      <input class="form-check-input" type="radio" name="dificultades2" id="dificultadesNoEspecificado" value="NO ESPECIFICADO"
             onclick="mostrarDescripcionDificultad(false)"
             <?php echo (!isset($usuario['dificultades2']) || $usuario['dificultades2']==='' || $usuario['dificultades2']==='NO ESPECIFICADO') ? 'checked' : ''; ?>>
      <label class="form-check-label" for="dificultadesNoEspecificado">NO ESPECIFICADO</label>
    </div>
  </div>

  <div id="descripcionDificultad" class="col-sm-12 mt-2" 
       style="display: <?php echo (isset($usuario['dificultades2']) && $usuario['dificultades2']==='SI') ? 'block' : 'none'; ?>;">
    <label class="form-label">¿Qué tipo de dificultades tienes?</label>
    <textarea class="form-control" name="descripcion_dificultad2" rows="2" 
              placeholder="Ej. Dificultad en matemáticas o problemas de atención"><?php 
              echo isset($usuario['descripcion_dificultad2']) && $usuario['descripcion_dificultad2']!=='' ? 
                   $usuario['descripcion_dificultad2'] : 'SIN DATOS'; 
              ?></textarea>
  </div>

  <div class="col-sm-6 mt-3">
    <label class="form-label">¿Cómo son tus relaciones con docentes y compañeros?</label>
    <textarea class="form-control" name="relaciones_escolares2" rows="2"
              placeholder="Ej. Me llevo bien con mis compañeros, pero tengo dificultades con algunos docentes"><?php 
              echo isset($usuario['relaciones_escolares2']) && $usuario['relaciones_escolares2']!=='' ? 
                   $usuario['relaciones_escolares2'] : 'SIN DATOS'; 
              ?></textarea>
  </div>
...
<div class="col-sm-6">
  ...
  <select class="form-select" id="convivencia" name="convivencia2">
    <?php
      $convivencia_actual = !empty($usuario['convivencia2']) ? $usuario['convivencia2'] : 'SIN DATOS';
    ?>
    <option value="" <?php echo ($convivencia_actual === '') ? 'selected' : ''; ?>>Seleccione una opción</option>
    <option value="Padres" <?php echo ($convivencia_actual === 'Padres') ? 'selected' : ''; ?>>Con mis padres</option>
    <option value="Madre" <?php echo ($convivencia_actual === 'Madre') ? 'selected' : ''; ?>>Solo con mi madre</option>
    <option value="Padre" <?php echo ($convivencia_actual === 'Padre') ? 'selected' : ''; ?>>Solo con mi padre</option>
    <option value="Abuelos" <?php echo ($convivencia_actual === 'Abuelos') ? 'selected' : ''; ?>>Con mis abuelos</option>
    <option value="Tíos" <?php echo ($convivencia_actual === 'Tíos') ? 'selected' : ''; ?>>Con mis tíos</option>
    <option value="Pareja" <?php echo ($convivencia_actual === 'Pareja') ? 'selected' : ''; ?>>Con mi pareja</option>
    <option value="Amigos" <?php echo ($convivencia_actual === 'Amigos') ? 'selected' : ''; ?>>Con amigos o compañeros</option>
    <option value="Solo(a)" <?php echo ($convivencia_actual === 'Solo(a)') ? 'selected' : ''; ?>>Vivo solo(a)</option>
    <option value="Otro" <?php echo ($convivencia_actual === 'Otro') ? 'selected' : ''; ?>>Otro</option>
    <?php if($convivencia_actual === 'SIN DATOS') { ?>
...
<div class="col-sm-6">
  ...
  <input type="number" 
         ...
         value="<?php echo !empty($usuario['num_personas_casa2']) ? $usuario['num_personas_casa2'] : ''; ?>">
  <div class="invalid-feedback">Por favor, ingresa un número válido (entre 1 y 20).</div>
  <?php if(empty($usuario['num_personas_casa2'])): ?>
    <small class="text-muted">SIN DATOS</small>
  <?php endif; ?>
</div>
...
<div class="col-sm-12">
  ...
  <textarea class="form-control" 
            ...
            rows="2" 
            placeholder="Ejemplo: mi mamá porque siempre me apoya, mi abuelo por sus consejos..."><?php 
                echo !empty($usuario['personas_significativas2']) ? htmlspecialchars($usuario['personas_significativas2']) : 'SIN DATOS'; 
            ?></textarea>
</div>
...
<div class="col-sm-6">
  ...
  <select class="form-select" id="sentir_casa" name="sentir_casa2">
    <?php
        $valor = !empty($usuario['sentir_casa2']) ? $usuario['sentir_casa2'] : 'No especificado';
    ?>
    <option value="" <?php echo $valor === 'No especificado' ? 'selected' : ''; ?>>Seleccione una opción</option>
    <option value="Muy bien" <?php echo $valor === 'Muy bien' ? 'selected' : ''; ?>>Muy bien</option>
    <option value="Bien" <?php echo $valor === 'Bien' ? 'selected' : ''; ?>>Bien</option>
    <option value="Regular" <?php echo $valor === 'Regular' ? 'selected' : ''; ?>>Regular</option>
    <option value="Mal" <?php echo $valor === 'Mal' ? 'selected' : ''; ?>>Mal</option>
    <option value="Muy mal" <?php echo $valor === 'Muy mal' ? 'selected' : ''; ?>>Muy mal</option>
    <?php if($valor === 'No especificado'): ?>
      <option value="No especificado" selected>SIN DATOS</option>
    <?php endif; ?>
  </select>
</div>
...
<div class="col-sm-6">
  ...
  <?php
    $valor = !empty($usuario['expresion_familiar2']) ? $usuario['expresion_familiar2'] : 'No especificado';
  ?>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="expresion_familiar2" id="expresionSi" value="SI"
      onclick="mostrarMotivoExpresion(false)" <?php echo $valor === 'SI' ? 'checked' : ''; ?>>
    <label class="form-check-label" for="expresionSi">Sí</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="expresion_familiar2" id="expresionNo" value="NO"
      onclick="mostrarMotivoExpresion(true)" <?php echo $valor === 'NO' ? 'checked' : ''; ?>>
    <label class="form-check-label" for="expresionNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="expresion_familiar2" id="expresionNoEspecificado" value="No especificado"
      onclick="mostrarMotivoExpresion(false)" <?php echo $valor === 'No especificado' ? 'checked' : ''; ?>>
    <label class="form-check-label" for="expresionNoEspecificado">SIN DATOS</label>
  </div>
</div>

<div class="col-sm-6" id="motivoExpresionDiv" style="display:<?php echo $valor === 'NO' ? 'block' : 'none'; ?>;">
  <label for="motivoExpresion" class="form-label">¿Por qué?</label>
  <input type="text" class="form-control" id="motivoExpresion" name="motivoExpresion2" 
         placeholder="Explica brevemente el motivo"
         value="<?php echo !empty($usuario['motivoExpresion2']) ? $usuario['motivoExpresion2'] : ''; ?>">
</div>
...
<h4>Contexto Social y Comunitario</h4>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="amistades_cercanas2" id="amistadesNo" value="NO" onclick="mostrarAmistades(false)"
      <?php echo $valor === 'NO' ? 'checked' : ''; ?>>
    <label class="form-check-label" for="amistadesNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="amistades_cercanas2" id="amistadesNoEspecificado" value="No especificado" onclick="mostrarAmistades(false)"
      <?php echo $valor === 'No especificado' ? 'checked' : ''; ?>>
    <label class="form-check-label" for="amistadesNoEspecificado">SIN DATOS</label>
  </div>
</div>

<div class="col-sm-6" id="detalleAmistades" style="display:<?php echo $valor === 'SI' ? 'block' : 'none'; ?>;">
  ...
  <input type="text" class="form-control" id="descripcion_amistades" name="descripcion_amistades2" placeholder="Ejemplo: mis compañeros de escuela, vecinos, amigos de infancia..."
         value="<?php echo !empty($usuario['descripcion_amistades2']) ? $usuario['descripcion_amistades2'] : ''; ?>">
</div>
...
<div class="col-sm-6">
  ...
  <textarea class="form-control" 
            id="actividades_libre" 
            name="actividades_libre2" 
            rows="3" 
            placeholder="Ejemplo: leer, ver series, hacer ejercicio, escuchar música, salir con amigos..."><?php echo !empty($usuario['actividades_libre2']) ? $usuario['actividades_libre2'] : 'SIN DATOS'; ?></textarea>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="uso_redes2" id="usoRedesSi" value="SI" 
           onclick="mostrarCamposRedes(true)" 
           <?php echo (isset($usuario['uso_redes2']) && $usuario['uso_redes2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="usoRedesSi">Sí</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="uso_redes2" id="usoRedesNo" value="NO" 
           onclick="mostrarCamposRedes(false)" 
           <?php echo (isset($usuario['uso_redes2']) && $usuario['uso_redes2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="usoRedesNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="uso_redes2" id="usoRedesSin" value="SIN DATOS" 
           onclick="mostrarCamposRedes(false)" 
           <?php echo empty($usuario['uso_redes2']) ? 'checked' : ''; ?>>
    <label class="form-check-label" for="usoRedesSin">No especificado</label>
  </div>
</div>

<!-- Campos que aparecen solo si elige "Sí" -->
<div id="camposRedes" style="display:<?php echo (isset($usuario['uso_redes2']) && $usuario['uso_redes2'] === 'SI') ? 'flex' : 'none'; ?>;" class="row mt-2">
  <div class="col-sm-6">
    <label class="form-label">¿Cuáles redes usas?</label>
    <input type="text" class="form-control" name="redes_cuales2" 
           value="<?php echo !empty($usuario['redes_cuales2']) ? $usuario['redes_cuales2'] : 'SIN DATOS'; ?>" 
           placeholder="Ej. Facebook, Instagram, TikTok...">
  </div>
  <div class="col-sm-6">
    <label class="form-label">¿Cuánto tiempo al día?</label>
    <input type="text" class="form-control" name="redes_tiempo2" 
           value="<?php echo !empty($usuario['redes_tiempo2']) ? $usuario['redes_tiempo2'] : 'SIN DATOS'; ?>" 
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="seguridad_comunidad2" id="seguridadSi" value="SI" 
           onclick="mostrarCampoSeguridad(false)" 
           <?php echo (isset($usuario['seguridad_comunidad2']) && $usuario['seguridad_comunidad2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="seguridadSi">Sí</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="seguridad_comunidad2" id="seguridadNo" value="NO" 
           onclick="mostrarCampoSeguridad(true)" 
           <?php echo (isset($usuario['seguridad_comunidad2']) && $usuario['seguridad_comunidad2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="seguridadNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="seguridad_comunidad2" id="seguridadSin" value="SIN DATOS" 
           onclick="mostrarCampoSeguridad(false)" 
           <?php echo empty($usuario['seguridad_comunidad2']) ? 'checked' : ''; ?>>
    <label class="form-check-label" for="seguridadSin">No especificado</label>
  </div>
</div>

<!-- Campo adicional solo si elige "No" -->
<div id="campoInseguridad" style="display:<?php echo (isset($usuario['seguridad_comunidad2']) && $usuario['seguridad_comunidad2'] === 'NO') ? 'block' : 'none'; ?>;" class="col-sm-6 mt-2">
  <label class="form-label">¿Por qué?</label>
  <textarea class="form-control" name="motivo_inseguridad2" rows="2" placeholder="Explica brevemente por qué no te sientes seguro..."><?php echo !empty($usuario['motivo_inseguridad2']) ? $usuario['motivo_inseguridad2'] : 'SIN DATOS'; ?></textarea>
</div>
...
<h4>Salud y Bienestar</h4>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="discapacidads2" id="discapacidadSi" value="SI" onclick="showDiscapacidadSelect()" 
           <?php echo (isset($usuario['discapacidads2']) && $usuario['discapacidads2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="discapacidadSi">SÍ</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="discapacidads2" id="discapacidadNo" value="NO" onclick="hideDiscapacidadSelect()" 
           <?php echo (isset($usuario['discapacidads2']) && $usuario['discapacidads2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="discapacidadNo">NO</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="discapacidads2" id="discapacidadSin" value="SIN DATOS" onclick="hideDiscapacidadSelect()" 
           <?php echo empty($usuario['discapacidads2']) ? 'checked' : ''; ?>>
    <label class="form-check-label" for="discapacidadSin">No especificado</label>
  </div>
</div>

<div class="col-sm-6" id="discapacidadSelectContainer2" style="display:<?php echo (isset($usuario['discapacidads2']) && $usuario['discapacidads2'] === 'SI') ? 'block' : 'none'; ?>;">
  <label for="tipoDiscapacidad2" class="form-label">¿CUÁL?</label>
  <select class="form-select" id="tipoDiscapacidad2" name="discapacidad2">
    <option disabled value="">SELECCIONAR TIPO...</option>
    <option value="MOTRIZ" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'MOTRIZ') ? 'selected' : ''; ?>>MOTRIZ</option>
    <option value="VISUAL" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'VISUAL') ? 'selected' : ''; ?>>VISUAL</option>
    <option value="AUDITIVA" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'AUDITIVA') ? 'selected' : ''; ?>>AUDITIVA</option>
    <option value="INTELECTUAL" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'INTELECTUAL') ? 'selected' : ''; ?>>INTELECTUAL</option>
    <option value="DEL LENGUAJE" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'DEL LENGUAJE') ? 'selected' : ''; ?>>DEL LENGUAJE</option>
    <option value="PSICOSOCIAL" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'PSICOSOCIAL') ? 'selected' : ''; ?>>PSICOSOCIAL</option>
    <option value="MULTIPLE" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'MULTIPLE') ? 'selected' : ''; ?>>MÚLTIPLE</option>
    <option value="OTRA" <?php echo (isset($usuario['discapacidad2']) && $usuario['discapacidad2'] === 'OTRA') ? 'selected' : ''; ?>>OTRA</option>
    <?php if(empty($usuario['discapacidad2'])): ?>
      <option value="SIN DATOS" selected>No especificado</option>
    <?php endif; ?>
  </select>
</div>
...
<script>
function showDiscapacidadSelect() {
  document.getElementById('discapacidadSelectContainer2').style.display = 'block';
}

function hideDiscapacidadSelect() {
  document.getElementById('discapacidadSelectContainer2').style.display = 'none';
  document.getElementById('tipoDiscapacidad2').value = ''; // Limpia selección
}
</script>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="apoyo_psicologico2" id="apoyoSi" value="SI" 
      onclick="mostrarCampoApoyo(true)"
      <?php echo (isset($usuario['apoyo_psicologico2']) && $usuario['apoyo_psicologico2'] === 'SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="apoyoSi">Sí</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="apoyo_psicologico2" id="apoyoNo" value="NO" 
      onclick="mostrarCampoApoyo(false)"
      <?php echo (isset($usuario['apoyo_psicologico2']) && $usuario['apoyo_psicologico2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="apoyoNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="apoyo_psicologico2" id="apoyoNoEspecificado" value="No especificado" 
      onclick="mostrarCampoApoyo(false)"
      <?php echo (empty($usuario['apoyo_psicologico2'])) ? 'checked' : ''; ?>>
    <label class="form-check-label" for="apoyoNoEspecificado">No especificado</label>
  </div>
</div>

<!-- Campo adicional solo si elige "Sí" -->
<div id="campoApoyo" style="display:<?php echo (isset($usuario['apoyo_psicologico2']) && $usuario['apoyo_psicologico2'] === 'SI') ? 'block' : 'none'; ?>;" class="col-sm-6 mt-2">
  <label class="form-label">¿Dónde o con quién recibiste el apoyo?</label>
  <input type="text" class="form-control" name="detalle_apoyo2" 
         value="<?php echo isset($usuario['detalle_apoyo2']) ? $usuario['detalle_apoyo2'] : ''; ?>"
         placeholder="Ejemplo: en la escuela, centro de salud, particular, etc.">
</div>
...
<div class="col-sm-6">
  ...
  <input type="text" class="form-control" name="estado_animo2" 
         value="<?php echo isset($usuario['estado_animo2']) ? $usuario['estado_animo2'] : ''; ?>"
...
<div class="col-sm-6">
  ...
  <textarea class="form-control" name="motivo_visita2" rows="3"><?php 
        echo isset($usuario['motivo_visita2']) && $usuario['motivo_visita2'] != '' 
             ? $usuario['motivo_visita2'] 
             : 'SIN DATOS'; 
  ?></textarea>
</div>
...
<div class="col-sm-6">
  ...
  <textarea class="form-control" name="descripcion_evento2" rows="3"><?php 
        echo isset($usuario['descripcion_evento2']) && $usuario['descripcion_evento2'] != '' 
             ? $usuario['descripcion_evento2'] 
             : 'SIN DATOS'; 
  ?></textarea>
</div>
...
<h4>Deteccion de Violencias</h4>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="controlan_actividad2" id="controlSi" value="SI"
      <?php echo (isset($usuario['controlan_actividad2']) && $usuario['controlan_actividad2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="controlan_actividad2" id="controlNo" value="NO"
      <?php echo (isset($usuario['controlan_actividad2']) && $usuario['controlan_actividad2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="controlNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="controlan_actividad2" id="controlNoEspecificado" value="NO ESPECIFICADO"
      <?php echo (!isset($usuario['controlan_actividad2']) || $usuario['controlan_actividad2'] === '') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="controlNoEspecificado">No especificado</label>
  </div>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_verbal2" id="insultosSi" value="SI"
      <?php echo (isset($usuario['violencia_verbal2']) && $usuario['violencia_verbal2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_verbal2" id="insultosNo" value="NO"
      <?php echo (isset($usuario['violencia_verbal2']) && $usuario['violencia_verbal2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="insultosNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_verbal2" id="insultosNoEspecificado" value="NO ESPECIFICADO"
      <?php echo (!isset($usuario['violencia_verbal2']) || $usuario['violencia_verbal2'] === '') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="insultosNoEspecificado">No especificado</label>
  </div>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_fisica2" id="golpesSi" value="SI"
      <?php echo (isset($usuario['violencia_fisica2']) && $usuario['violencia_fisica2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_fisica2" id="golpesNo" value="NO"
      <?php echo (isset($usuario['violencia_fisica2']) && $usuario['violencia_fisica2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="golpesNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_fisica2" id="golpesNoEspecificado" value="NO ESPECIFICADO"
      <?php echo (!isset($usuario['violencia_fisica2']) || $usuario['violencia_fisica2'] === '') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="golpesNoEspecificado">No especificado</label>
  </div>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_sexual2" id="tocadoSi" value="SI"
      <?php echo (isset($usuario['violencia_sexual2']) && $usuario['violencia_sexual2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_sexual2" id="tocadoNo" value="NO"
      <?php echo (isset($usuario['violencia_sexual2']) && $usuario['violencia_sexual2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="tocadoNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="violencia_sexual2" id="tocadoNoEspecificado" value="NO ESPECIFICADO"
      <?php echo (!isset($usuario['violencia_sexual2']) || $usuario['violencia_sexual2'] === '') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="tocadoNoEspecificado">No especificado</label>
  </div>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="impiden_estudiar2" id="impidenSi" value="SI"
      <?php echo (isset($usuario['impiden_estudiar2']) && $usuario['impiden_estudiar2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="impiden_estudiar2" id="impidenNo" value="NO"
      <?php echo (isset($usuario['impiden_estudiar2']) && $usuario['impiden_estudiar2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="impidenNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="impiden_estudiar2" id="impidenNoEspecificado" value="NO ESPECIFICADO"
      <?php echo (!isset($usuario['impiden_estudiar2']) || $usuario['impiden_estudiar2'] === '') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="impidenNoEspecificado">No especificado</label>
  </div>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="difusion_sin_permiso2" id="difusionSi" value="SI"
      <?php echo (isset($usuario['difusion_sin_permiso2']) && $usuario['difusion_sin_permiso2'] === 'SI') ? 'checked' : ''; ?>>
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="difusion_sin_permiso2" id="difusionNo" value="NO"
      <?php echo (isset($usuario['difusion_sin_permiso2']) && $usuario['difusion_sin_permiso2'] === 'NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="difusionNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="difusion_sin_permiso2" id="difusionNoEspecificado" value="NO ESPECIFICADO"
      <?php echo (!isset($usuario['difusion_sin_permiso2']) || $usuario['difusion_sin_permiso2'] === '') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="difusionNoEspecificado">No especificado</label>
  </div>
</div>
...
<div class="col-sm-12">
  ...
  <textarea class="form-control" name="observacionesvi2" rows="3" placeholder="Escribe aquí cualquier observación o comentario adicional..."><?php echo !empty($usuario['observacionesvi2']) ? $usuario['observacionesvi2'] : 'SIN DATOS'; ?></textarea>
</div>
...
<div class="col-sm-6">
    ...
    <select class="form-select" id="ocupacion" name="ocupacion2">
        <?php 
            $ocupaciones = [
                "Ama de casa","Campesino/a","Artesano/a","Comerciante","Empleado/a",
                "Estudiante","Maestro/a","Profesional independiente","Servidor público",
                "Desempleado/a","Otro"
            ];
            $valor_actual = !empty($usuario['ocupacion2']) ? $usuario['ocupacion2'] : 'SIN DATOS';
        ?>
        <option value="">Selecciona una ocupación</option>
        <?php 
        foreach($ocupaciones as $ocupacion) {
            $selected = ($valor_actual === $ocupacion) ? 'selected' : '';
            echo "<option value=\"$ocupacion\" $selected>$ocupacion</option>";
        } 
        ?>
        <?php if($valor_actual === 'SIN DATOS') echo '<option value="SIN DATOS" selected>SIN DATOS</option>'; ?>
    </select>
    <div class="invalid-feedback">Se requiere una ocupación válida.</div>
</div>
...
<div class="col-sm-6">
  ...
  <select class="form-select" id="tipoEmpleo" name="tipoEmpleo2">
    <?php 
      $tipos = ["FORMAL", "INFORMAL", "DESEMPLEADA"];
      $valor_actual = !empty($usuario['tipoEmpleo2']) ? $usuario['tipoEmpleo2'] : 'SIN DATOS';
    ?>
    <option value="">Selecciona una opción</option>
    <?php 
      foreach($tipos as $tipo) {
        $selected = ($valor_actual === $tipo) ? 'selected' : '';
...
<div class="col-sm-6" id="DondeTrabaja">
    ...
    <input type="text" 
           ...
           id="Trabaja" 
           name="DondeTrabaja2"
           value="<?php echo !empty($usuario['DondeTrabaja2']) ? $usuario['DondeTrabaja2'] : 'SIN DATOS'; ?>">
    <div class="invalid-feedback">Se requiere un dato válido.</div>
</div>
...
<div class="col-sm-6">
    ...
    <select class="form-select" id="fuenteIngresos" name="fuenteIngresos2">
        <option value="" <?php echo empty($usuario['fuenteIngresos2']) ? 'selected' : ''; ?>>SIN DATOS</option>
        <option value="Trabajo propio" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Trabajo propio') ? 'selected' : ''; ?>>Trabajo propio</option>
        <option value="Trabajo asalariado" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Trabajo asalariado') ? 'selected' : ''; ?>>Trabajo asalariado</option>
        <option value="Comercio informal" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Comercio informal') ? 'selected' : ''; ?>>Comercio informal</option>
        <option value="Agricultura o ganadería" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Agricultura o ganadería') ? 'selected' : ''; ?>>Agricultura o ganadería</option>
        <option value="Artesanías" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Artesanías') ? 'selected' : ''; ?>>Artesanías</option>
        <option value="Apoyo gubernamental" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Apoyo gubernamental') ? 'selected' : ''; ?>>Apoyo gubernamental</option>
        <option value="Remesas" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Remesas') ? 'selected' : ''; ?>>Remesas</option>
        <option value="Pensión o jubilación" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Pensión o jubilación') ? 'selected' : ''; ?>>Pensión o jubilación</option>
        <option value="No tiene ingresos" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'No tiene ingresos') ? 'selected' : ''; ?>>No tiene ingresos</option>
        <option value="Otro" <?php echo (!empty($usuario['fuenteIngresos2']) && $usuario['fuenteIngresos2'] == 'Otro') ? 'selected' : ''; ?>>Otro</option>
    </select>
    <div class="invalid-feedback">Se requiere una fuente de ingresos válida.</div>
</div>
...
<div class="col-sm-6">
    <label for="sectorEconomico" class="form-label">Sector económico</label>
    <select class="form-select" id="sectorEconomico" name="sectorEconomico2">
        <option value="" <?php echo empty($usuario['sectorEconomico2']) ? 'selected' : ''; ?>>SIN DATOS</option>
        <option value="SERVICIOS SOCIALES" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'SERVICIOS SOCIALES') ? 'selected' : ''; ?>>SERVICIOS SOCIALES</option>
        <option value="INDUSTRIA MANUFACTURERA" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'INDUSTRIA MANUFACTURERA') ? 'selected' : ''; ?>>INDUSTRIA MANUFACTURERA</option>
        <option value="COMERCIO" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'COMERCIO') ? 'selected' : ''; ?>>COMERCIO</option>
        <option value="SERVICIOS DIVERSOS" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'SERVICIOS DIVERSOS') ? 'selected' : ''; ?>>SERVICIOS DIVERSOS</option>
        <option value="SERVICIOS PROFESIONALES, FINANCIEROS Y CORPORATIVOS" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'SERVICIOS PROFESIONALES, FINANCIEROS Y CORPORATIVOS') ? 'selected' : ''; ?>>SERVICIOS PROFESIONALES, FINANCIEROS Y CORPORATIVOS</option>
        <option value="RESTAURANTES Y SERVICIOS DE ALOJAMIENTO" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'RESTAURANTES Y SERVICIOS DE ALOJAMIENTO') ? 'selected' : ''; ?>>RESTAURANTES Y SERVICIOS DE ALOJAMIENTO</option>
        <option value="GOBIERNO Y ORGANISMOS INTERNACIONALES" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'GOBIERNO Y ORGANISMOS INTERNACIONALES') ? 'selected' : ''; ?>>GOBIERNO Y ORGANISMOS INTERNACIONALES</option>
        <option value="AGRICULTURA, GANADERÍA, SILVICULTURA Y PESCA" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'AGRICULTURA, GANADERÍA, SILVICULTURA Y PESCA') ? 'selected' : ''; ?>>AGRICULTURA, GANADERÍA, SILVICULTURA Y PESCA</option>
        <option value="TRANSPORTES Y ALMACENAMIENTO" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'TRANSPORTES Y ALMACENAMIENTO') ? 'selected' : ''; ?>>TRANSPORTES Y ALMACENAMIENTO</option>
        <option value="CONSTRUCCIÓN" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'CONSTRUCCIÓN') ? 'selected' : ''; ?>>CONSTRUCCIÓN</option>
        <option value="INDUSTRIA EXTRACTIVA Y ELECTRICIDAD" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'INDUSTRIA EXTRACTIVA Y ELECTRICIDAD') ? 'selected' : ''; ?>>INDUSTRIA EXTRACTIVA Y ELECTRICIDAD</option>
        <option value="OTRO" <?php echo (!empty($usuario['sectorEconomico2']) && $usuario['sectorEconomico2'] == 'OTRO') ? 'selected' : ''; ?>>OTRO</option>
    </select>
    <div class="invalid-feedback">Se requiere seleccionar un sector económico.</div>
</div>
...
<div class="col-sm-6">
    <label for="horasTrabajo" class="form-label">Horas de trabajo al Día</label>
    <input type="number" min="0" max="24" class="form-control" id="horasTrabajo" name="horasTrabajo2" 
           value="<?php echo !empty($usuario['horasTrabajo2']) ? $usuario['horasTrabajo2'] : ''; ?>" 
           placeholder="<?php echo empty($usuario['horasTrabajo2']) ? 'SIN DATOS' : ''; ?>">
    <div class="invalid-feedback">Se requiere un número válido de horas de trabajo.</div>
</div>
  ...
  <div class="col-sm-6">
    <label for="ingresosDiarios" class="form-label">Ingresos Diarios</label>
    <input type="number" min="0" max="1000000" class="form-control" id="ingresosDiarios" name="ingresosDiarios2" 
           value="<?php echo !empty($usuario['ingresosDiarios2']) ? $usuario['ingresosDiarios2'] : ''; ?>" 
           placeholder="<?php echo empty($usuario['ingresosDiarios2']) ? 'SIN DATOS' : ''; ?>">
    <div class="invalid-feedback">Se requiere un número válido de ingresos diarios.</div>
</div>
...
<div class="col-sm-6 ">
  ...
  <input 
    ...
    min="0" 
    step="100"
    value="<?php echo !empty($usuario['ingresoMensual2']) ? $usuario['ingresoMensual2'] : ''; ?>" 
    placeholder="<?php echo empty($usuario['ingresoMensual2']) ? 'SIN DATOS' : ''; ?>"
  >
  <div class="invalid-feedback">Por favor, ingresa un monto válido.</div>
</div>
...
<div class="col-sm-6 ">
  ...
  <select class="form-select" id="apoyosSociales" name="apoyosSociales2">
    <option value=""><?php echo empty($usuario['apoyosSociales2']) ? 'SIN DATOS' : 'Selecciona una opción'; ?></option>
    <option value="PROSPERA" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='PROSPERA') ? 'selected' : ''; ?>>PROSPERA</option>
    <option value="PENSION_ADULTO_MAYOR" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='PENSION_ADULTO_MAYOR') ? 'selected' : ''; ?>>PENSIÓN ADULTO MAYOR</option>
    <option value="PENSION_DISCAPACIDAD" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='PENSION_DISCAPACIDAD') ? 'selected' : ''; ?>>PENSIÓN DISCAPACIDAD</option>
    <option value="SUBSIDIO" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='SUBSIDIO') ? 'selected' : ''; ?>>SUBSIDIO</option>
    <option value="REMESAS" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='REMESAS') ? 'selected' : ''; ?>>REMESAS</option>
    <option value="NEGOCIO_PROPIO" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='NEGOCIO_PROPIO') ? 'selected' : ''; ?>>NEGOCIO PROPIO</option>
    <option value="OTRO" <?php echo (isset($usuario['apoyosSociales2']) && $usuario['apoyosSociales2']=='OTRO') ? 'selected' : ''; ?>>OTRO</option>
  </select>
</div>
...
<div class="col-sm-6 ">
  <label class="form-label">¿Recibe apoyo económico de otras personas?</label>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="recibeApoyo2" id="recibeApoyoSi" value="SI"
      onclick="showApoyoDetalle()" <?php echo (isset($usuario['recibeApoyo2']) && $usuario['recibeApoyo2']=='SI') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="recibeApoyoSi">Sí</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="recibeApoyo2" id="recibeApoyoNo" value="NO"
      onclick="hideApoyoDetalle()" <?php echo (isset($usuario['recibeApoyo2']) && $usuario['recibeApoyo2']=='NO') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="recibeApoyoNo">No</label>
  </div>
  <div class="form-check">
    <input class="form-check-input" type="radio" name="recibeApoyo2" id="recibeApoyoSinDatos" value=""
      onclick="hideApoyoDetalle()" <?php echo (!isset($usuario['recibeApoyo2']) || $usuario['recibeApoyo2']=='') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="recibeApoyoSinDatos">SIN DATOS</label>
  </div>
</div>

<div class="col-sm-6 " id="apoyoDetalleContainer" style="display: <?php echo (isset($usuario['recibeApoyo2']) && $usuario['recibeApoyo2']=='SI') ? 'block' : 'none'; ?>;">
  <label for="apoyoDetalle" class="form-label">¿De quién?</label>
  <select class="form-select" id="apoyoDetalle" name="apoyoDetalle2">
    <option value="">Selecciona una opción</option>
    <option value="PADRE" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='PADRE') ? 'selected' : ''; ?>>PADRE</option>
    <option value="MADRE" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='MADRE') ? 'selected' : ''; ?>>MADRE</option>
    <option value="HERMANO_HERMANA" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='HERMANO_HERMANA') ? 'selected' : ''; ?>>HERMANO / HERMANA</option>
    <option value="ABUELO_ABUELA" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='ABUELO_ABUELA') ? 'selected' : ''; ?>>ABUELO / ABUELA</option>
    <option value="TIO_TIA" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='TIO_TIA') ? 'selected' : ''; ?>>TÍO / TÍA</option>
    <option value="PRIMO_PRIMA" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='PRIMO_PRIMA') ? 'selected' : ''; ?>>PRIMO / PRIMA</option>
    <option value="OTRO" <?php echo (isset($usuario['apoyoDetalle2']) && $usuario['apoyoDetalle2']=='OTRO') ? 'selected' : ''; ?>>OTRO</option>
  </select>
</div>
...
<div class="col-sm-6">
  ...
  <div class="form-check">
    <input class="form-check-input" type="radio" name="enteroGESMUJER2" id="iniciativa" value="Acudió por iniciativa propia"
      <?php echo (isset($usuario['enteroGESMUJER2']) && $usuario['enteroGESMUJER2']=='Acudió por iniciativa propia') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="iniciativa">Acudió por iniciativa propia</label>
  </div>

  <div class="form-check">
    <input class="form-check-input" type="radio" name="enteroGESMUJER2" id="recomendacion" value="Recomendación de familiar o amistad"
      <?php echo (isset($usuario['enteroGESMUJER2']) && $usuario['enteroGESMUJER2']=='Recomendación de familiar o amistad') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="recomendacion">Recomendación de familiar o amistad</label>
  </div>

  <div class="form-check">
    <input class="form-check-input" type="radio" name="enteroGESMUJER2" id="canalizada" value="Canalizada por institución"
      <?php echo (isset($usuario['enteroGESMUJER2']) && $usuario['enteroGESMUJER2']=='Canalizada por institución') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="canalizada">Canalizada por institución</label>
  </div>

  <div class="form-check">
    <input class="form-check-input" type="radio" name="enteroGESMUJER2" id="redes" value="Redes sociales"
      <?php echo (isset($usuario['enteroGESMUJER2']) && $usuario['enteroGESMUJER2']=='Redes sociales') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="redes">Redes sociales</label>
  </div>

  <div class="form-check">
    <input class="form-check-input" type="radio" name="enteroGESMUJER2" id="otro" value="Otro"
      <?php echo (isset($usuario['enteroGESMUJER2']) && $usuario['enteroGESMUJER2']=='Otro') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="otro">Otro</label>
  </div>

  <!-- Opción SIN DATOS si no hay valor en la base -->
  <div class="form-check">
    <input class="form-check-input" type="radio" name="enteroGESMUJER2" id="sinDatos" value=""
      <?php echo (!isset($usuario['enteroGESMUJER2']) || $usuario['enteroGESMUJER2']=='') ? 'checked' : ''; ?>>
    <label class="form-check-label" for="sinDatos">SIN DATOS</label>
  </div>
</div>
...
<div class="col-sm-12">
  <label for="descripcionSolicitud" class="form-label">Descripción y motivo de la solicitud</label>
  <textarea class="form-control" id="descripcionSolicitud" name="descripcionSolicitud2" rows="4" placeholder="Describa brevemente el motivo de su solicitud..."><?php 
    echo isset($usuario['descripcionSolicitud2']) && $usuario['descripcionSolicitud2'] !== '' 
         ? htmlspecialchars($usuario['descripcionSolicitud2']) 
         : 'SIN DATOS'; 
  ?></textarea>
</div>
...
Swal.fire({
    ...
    window.location.href = "../pages/ver-usuario-adolecente.php";
});
</script>
<?php endif; ?>
