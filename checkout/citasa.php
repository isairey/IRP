...
try {
    ...
    $query = "SELECT nombre2, apellidoPaterno2, apellidoMaterno2, fechaNacimiento2, edad2, sexo2, 
                     orientacionSexual2, estadocivil2, lugarNacimiento2, lenguaMaterna2, lenguaIndigena2, fechaRegistro2
              FROM tutor
              WHERE id = :usuario_id
              LIMIT 1";
