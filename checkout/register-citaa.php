...
<html lang="en" data-bs-theme="auto">
    ...
    <div class="col-xxl-12 col-xxl-12">
        ...
        <form class="needs-validation" action="register-citaa.php" method="POST" enctype="multipart/form-data"  novalidate>
    <div class="row g-3">
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    input.addEventListener("keyup", () => {
        ...
        fetch("./ajax/buscar_tutor.php?q=" + encodeURIComponent(texto))
            .then(res => res.json())
            .then(data => {
                sugerencias.innerHTML = "";
                if (data.length > 0) {
...
Swal.fire({
    ...
    window.location.href = "../pages/ver-citasa.php";
});
</script>
<?php endif; ?>
