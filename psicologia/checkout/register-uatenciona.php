...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt->execute();
              header("Location: ../pages/ver-atencionesa.php?statuss=success");
exit();
    } catch (PDOException $e) {
       $conn->rollBack();
        header("Location: ../pages/ver-atencionesa.php?statuss=error&msg=" . urlencode($e->getMessage()));
exit();
    }
...
?>
    ...
    <div class="col-xxl-12 col-xxl-12">
        ...
        <form class="needs-validation" action="register-uatenciona.php" method="POST" enctype="multipart/form-data"  novalidate>
    <div class="row g-3">
