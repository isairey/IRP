...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        // Ejecutar la consulta
          $stmt->execute();
              header("Location: ../pages/ver-citas.php?status=success");
exit();
    } catch (PDOException $e) {
       $conn->rollBack();
        header("Location: ../pages/ver-citas.php?status=error&msg=" . urlencode($e->getMessage()));
exit();
    }
...
$id_usuario = urldecode($_GET['id_usuario'] != '');
