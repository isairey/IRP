...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Domicilio Personal</h1>
    ...
    <button class="boton-morado" type="button" onclick="window.location.href='../pages/p-domicilio.php'">Datos de Domicilio</button>
      ...
      <form for="search" class="d-flex" role="search">
        ...
        <button class="btn btn-outline-secondary" type="button" onclick="window.location.href='../pages/p-domicilio.php'"><i class="bi bi-arrow-repeat"></i></button>
      </form>
...
try {
    ...
    foreach ($personales as $personal) {
        ...
        echo "<td>{$personal['Calle']}</td>";
        echo "<td>{$personal['NumInterior']}</td>";
        echo "<td>{$personal['NumExterior']}</td>";
        echo "<td>{$personal['CP']}</td>";
        echo "<td>{$personal['Estado']}</td>";
        echo "<td>{$personal['Municipio']}</td>";
        echo "<td>{$personal['Colonia']}</td>";
        echo "<td>{$personal['Region']}</td>";
       /* echo "<td>";
        // Botón para editar
