...
<div class="container-fluid">
  <div class="row">
      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="../checkout/register-usuario.php">
          ...
          <ul class="nav flex-column mb-auto">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="#">
                <svg class="bi"><use xlink:href="#file-earmark-text-fill"/></svg>
                Current month
              </a>
            </li>
            <li class="nav-item">
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <button class="btn btn-link rounded-pill px-3" type="submit" name="logout">Link</button>
            </form>
        </ul>
    ...
    <form method="GET">
        <label for="search">Buscar por nombre completo:</label>
    ...
    <table class="table table-striped table-sm">
        ...
        <tbody>
            <?php
            require_once '/xampp/htdocs/SIGD/db/config.php'; // Ruta al archivo de configuración
